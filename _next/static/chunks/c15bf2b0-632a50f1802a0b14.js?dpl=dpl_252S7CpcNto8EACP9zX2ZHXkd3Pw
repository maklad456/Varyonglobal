    ...
    934: (t, e, r) => {
          ...
          return x(r) && (isNaN(r) || r in o)
            ? ((s = r.charAt(0)),
              ...
              : ((s = parseFloat(r.charAt(n - 1) + r.substr(n + 1))),
                a && i && (s = (s / 100) * (O(i) ? i[0] : i).totalDuration()),
          ...
          return (
            ...
            (e.totalTime = function (t, e) {
              ...
              if (r && r.smoothChildTiming && this._ts) {
                for (
                  tO(this, t), !r._dp || r.parent || tP(r, this);
                  r && r.parent;
            ...
            (e.restart = function (t, e) {
              return (
                this.play().totalTime(t ? -this._delay : 0, R(e)),
          ...
          (r.render = function (t, e, r) {
            ...
            if (
              ...
              if (
                ...
                return (this._start = c), tz(this), this.render(t, e, r);
      ...
      var eR,
        ...
        eO = function (t, e, r, i, n) {
          if (
            (D(t) && (t = eB(t, n, e, r, i)),
            !C(t) || (t.style && t.nodeType) || O(t) || z(t))
          )
        ...
        eF = function t(e, r, i) {
          ...
          if (
            ...
            for (
              o = 0, e._pt = e._ptCache = 0, D = (z && R(D)) || (D && !z);
              o < P.length;
              o++
            ) {
              if (
                ...
                for (h in n)
                  tt[h] && (p = eP(h, n, e, g, f, L))
                    ? p.priority && (l = 1)
                    : (m[h] = _ =
                        ez.call(e, f, h, "get", n[h], g, L, 0, w.stringFilter));
            ...
            if (
              ...
              for (h = 0; h < f; h++)
                ((_ = tT(r, eN)).stagger = 0),
                  ...
                  p && tg(_, p),
                  (c = F[h]),
                  (_.duration = +eB(y, i(v), h, c, F)),
                  (_.delay = (+eB(T, i(v), h, c, F) || 0) - v._delay),
                  !b &&
                    1 === f &&
                    _.delay &&
                    ((v._delay = T = _.delay), (v._start += T), (_.delay = 0)),
                  o.to(c, _, d ? d(h, c, F) : 0),
                  (o._ease = ec.none);
              o.duration() ? (y = T = 0) : (v.timeline = 0);
            } else if (x) {
              tw(tv(o.vars.defaults, { ease: "none" })),
              ...
              if (O(x))
                ...
                for (l in ((_ = {}), x))
                  "ease" === l ||
                    "easeEach" === l ||
                    eU(l, x[l], _, x.easeEach);
                for (l in _)
                  for (
                    h = 0,
                      L = _[l].sort(function (t, e) {
                        return t.t - e.t;
                      }),
                      B = 0;
                    h < L.length;
                    ...
                    ((U = {
                      ...
                      o.to(F, U, B),
                      (B += U.duration);
                o.duration() < y && o.to({}, { duration: y - o.duration() });
              }
            }
            y || v.duration((y = o.duration()));
          } else v.timeline = 0;
          return (
            !0 !== k || s || ((eR = i(v)), u.killTweensOf(F), (eR = 0)),
            tF(P, i(v), n),
            ...
            (w ||
              (!y &&
                ...
                "nested" !== P.data)) &&
              ((v._tTime = -1e-8), v.render(Math.max(0, -T) || 0)),
            A && tL(i(v), A),
            v
          );
        }
            ...
            (e.kill = function (t, e) {
              ...
              if (t) {
                ...
                for (
                  ...
                  (i = r.data[s]) instanceof eC
                    ? "nested" !== i.data &&
                      (i.scrollTrigger && i.scrollTrigger.revert(), i.kill())
                    : i instanceof eQ || !i.revert || i.revert(t);
              ...
              if ((this.clear(), e))
                for (var a = e5.length; a--; )
                  e5[a].id === this.id && e5.splice(a, 1);
            }),
            (e.revert = function (t) {
              this.kill(t || {});
            }),
      ...
      (eQ.version = eC.version = ra.version = "3.12.7"),
        (l = 1),
        E() && el(),
        ec.Power0,
        ec.Power1,
