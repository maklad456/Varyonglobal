...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [367],
  {
    7431: (e, n, t) => {
      t.r(n),
        t.d(n, {
          ACESFilmicToneMapping: () => r.FV,
          AddEquation: () => r.gO9,
          AddOperation: () => r.XrR,
          AdditiveAnimationBlendMode: () => r.DAe,
          AdditiveBlending: () => r.EZo,
          AgXToneMapping: () => r.LAk,
          AlphaFormat: () => r.wrO,
          AlwaysCompare: () => r.FFZ,
          AlwaysDepth: () => r.lGu,
          AlwaysStencilFunc: () => r.sKt,
          AmbientLight: () => r.$p8,
          AnimationAction: () => r.pPE,
          AnimationClip: () => r.tz3,
          AnimationLoader: () => r.kEx,
          AnimationMixer: () => r.Iw4,
          AnimationObjectGroup: () => r.P5j,
          AnimationUtils: () => r.AKb,
          ArcCurve: () => r.ibB,
          ArrayCamera: () => r.nZQ,
          ArrowHelper: () => r.E0M,
          AttachedBindMode: () => r.BER,
          Audio: () => r.fP5,
          AudioAnalyser: () => r.CwR,
          AudioContext: () => r.UtX,
          AudioListener: () => r.Pf$,
          ...
          AxesHelper: () => r.IzY,
          BackSide: () => r.hsX,
          BasicDepthPacking: () => r.Rkk,
          BasicShadowMap: () => r.bTm,
          BatchedMesh: () => r.$Ed,
          Bone: () => r.$Kf,
          BooleanKeyframeTrack: () => r.YOZ,
          Box2: () => r.UtB,
          Box3: () => r.NRn,
          Box3Helper: () => r.BND,
          BoxGeometry: () => r.iNn,
          BoxHelper: () => r.IWo,
          BufferAttribute: () => r.THS,
          BufferGeometry: () => r.LoY,
          BufferGeometryLoader: () => r.SUR,
          ByteType: () => r.tJf,
          Cache: () => r.l2R,
          Camera: () => r.i7d,
          CameraHelper: () => r.WTh,
          CanvasTexture: () => r.GOR,
          CapsuleGeometry: () => r.qU7,
          CatmullRomCurve3: () => r.B6O,
          CineonToneMapping: () => r.nNL,
          CircleGeometry: () => r.tcD,
          ClampToEdgeWrapping: () => r.ghU,
          Clock: () => r.zD7,
          Color: () => r.Q1f,
          ColorKeyframeTrack: () => r.T6I,
          ColorManagement: () => r.ppV,
          CompressedArrayTexture: () => r.iOZ,
          CompressedCubeTexture: () => r.c5h,
          CompressedTexture: () => r.FvD,
          CompressedTextureLoader: () => r.YRT,
          ConeGeometry: () => r.qFE,
          ConstantAlphaFactor: () => r.e0p,
          ConstantColorFactor: () => r.RrE,
          Controls: () => r.H2z,
          CubeCamera: () => r.F1T,
          CubeReflectionMapping: () => r.hy7,
          CubeRefractionMapping: () => r.xFO,
          CubeTexture: () => r.b4q,
          CubeTextureLoader: () => r.ScU,
          CubeUVReflectionMapping: () => r.Om,
          CubicBezierCurve: () => r.Z0B,
          CubicBezierCurve3: () => r.s0K,
          CubicInterpolant: () => r.Pdi,
          CullFaceBack: () => r.Vb5,
          CullFaceFront: () => r.Jnc,
          CullFaceFrontBack: () => r.ywQ,
          CullFaceNone: () => r.WNZ,
          Curve: () => r.Ipv,
          CurvePath: () => r.jGm,
          CustomBlending: () => r.bCz,
          CustomToneMapping: () => r.g7M,
          CylinderGeometry: () => r.Ho_,
          Cylindrical: () => r.hjs,
          Data3DTexture: () => r.dYF,
          DataArrayTexture: () => r.rFo,
          DataTexture: () => r.GYF,
          DataTextureLoader: () => r.BRH,
          DataUtils: () => r.GxU,
          DecrementStencilOp: () => r.ROr,
          DecrementWrapStencilOp: () => r.fJr,
          DefaultLoadingManager: () => r.h_9,
          DepthFormat: () => r.zdS,
          DepthStencilFormat: () => r.dcC,
          DepthTexture: () => r.VCu,
          DetachedBindMode: () => r.Fvi,
          DirectionalLight: () => r.ZyN,
          DirectionalLightHelper: () => r.PFK,
          DiscreteInterpolant: () => r.Yhb,
          DodecahedronGeometry: () => r.nEu,
          DoubleSide: () => r.$EB,
          DstAlphaFactor: () => r.hdd,
          DstColorFactor: () => r.wn6,
          DynamicCopyUsage: () => r.MOq,
          DynamicDrawUsage: () => r.Vnu,
          DynamicReadUsage: () => r.hIf,
          EdgesGeometry: () => r.TDQ,
          EllipseCurve: () => r.S20,
          EqualCompare: () => r.kO0,
          EqualDepth: () => r.U3G,
          EqualStencilFunc: () => r.jsO,
          EquirectangularReflectionMapping: () => r.wfO,
          EquirectangularRefractionMapping: () => r.uV5,
          Euler: () => r.O9p,
          EventDispatcher: () => r.Qev,
          ExtrudeGeometry: () => r.QCA,
          FileLoader: () => r.Y9S,
          Float16BufferAttribute: () => r.Oax,
          Float32BufferAttribute: () => r.qtW,
          FloatType: () => r.RQf,
          Fog: () => r.jUj,
          FogExp2: () => r.cRK,
          FramebufferTexture: () => r.Pem,
          FrontSide: () => r.hB5,
          Frustum: () => r.PPD,
          GLBufferAttribute: () => r.oh6,
          GLSL1: () => r.Wyr,
          GLSL3: () => r.Wdf,
          GreaterCompare: () => r.eoi,
          GreaterDepth: () => r.K52,
          GreaterEqualCompare: () => r.gWB,
          GreaterEqualDepth: () => r.Gwm,
          GreaterEqualStencilFunc: () => r.TMh,
          GreaterStencilFunc: () => r.RcT,
          GridHelper: () => r.fTw,
          Group: () => r.YJl,
          HalfFloatType: () => r.ix0,
          HemisphereLight: () => r.dth,
          HemisphereLightHelper: () => r.R1W,
          IcosahedronGeometry: () => r.WBB,
          ImageBitmapLoader: () => r.Kzg,
          ImageLoader: () => r.$NF,
          ImageUtils: () => r.HgN,
          IncrementStencilOp: () => r.HLH,
          IncrementWrapStencilOp: () => r.Ru$,
          InstancedBufferAttribute: () => r.uWO,
          InstancedBufferGeometry: () => r.CmU,
          InstancedInterleavedBuffer: () => r.LuO,
          InstancedMesh: () => r.ZLX,
          Int16BufferAttribute: () => r.Hrb,
          Int32BufferAttribute: () => r.vmz,
          Int8BufferAttribute: () => r.wvS,
          IntType: () => r.Yuy,
          InterleavedBuffer: () => r.eB$,
          InterleavedBufferAttribute: () => r.eHs,
          Interpolant: () => r.lGw,
          InterpolateDiscrete: () => r.ljd,
          InterpolateLinear: () => r.PJ3,
          InterpolateSmooth: () => r.EQC,
          InvertStencilOp: () => r.oVO,
          KeepStencilOp: () => r.VVr,
          KeyframeTrack: () => r.UJ6,
          LOD: () => r.UpK,
          LatheGeometry: () => r.nzx,
          ...
          LessCompare: () => r.vim,
          LessDepth: () => r.brA,
          LessEqualCompare: () => r.TiK,
          LessEqualDepth: () => r.xSv,
          LessEqualStencilFunc: () => r.CR7,
          LessStencilFunc: () => r.kYr,
          Light: () => r.veJ,
          LightProbe: () => r.FZo,
          Line: () => r.N1A,
          Line3: () => r.cZY,
          LineBasicMaterial: () => r.mrM,
          LineCurve: () => r.GZZ,
          LineCurve3: () => r.VnP,
          LineDashedMaterial: () => r.Fvt,
          LineLoop: () => r.FCc,
          LineSegments: () => r.DXC,
          LinearFilter: () => r.k6q,
          LinearInterpolant: () => r.ezk,
          LinearMipMapLinearFilter: () => r.NZq,
          LinearMipMapNearestFilter: () => r.iUH,
          LinearMipmapLinearFilter: () => r.$_I,
          LinearMipmapNearestFilter: () => r.kRr,
          LinearSRGBColorSpace: () => r.Zr2,
          LinearToneMapping: () => r.kyO,
          LinearTransfer: () => r.VxR,
          Loader: () => r.aHM,
          LoaderUtils: () => r.r6x,
          LoadingManager: () => r.KPJ,
          LoopOnce: () => r.G3T,
          LoopPingPong: () => r.lc7,
          LoopRepeat: () => r.aMy,
          LuminanceAlphaFormat: () => r.CMB,
          LuminanceFormat: () => r.Kzv,
          MOUSE: () => r.kBv,
          Material: () => r.imn,
          MaterialLoader: () => r.jut,
          MathUtils: () => r.cj9,
          Matrix2: () => r.k_V,
          Matrix3: () => r.dwI,
          Matrix4: () => r.kn4,
          MaxEquation: () => r.$ei,
          Mesh: () => r.eaF,
          MeshBasicMaterial: () => r.V9B,
          MeshDepthMaterial: () => r.CSG,
          MeshDistanceMaterial: () => r.aVO,
          MeshLambertMaterial: () => r.G_z,
          MeshMatcapMaterial: () => r.FNr,
          MeshNormalMaterial: () => r.qBx,
          MeshPhongMaterial: () => r.tXL,
          MeshPhysicalMaterial: () => r.uSd,
          MeshStandardMaterial: () => r._4j,
          MeshToonMaterial: () => r.Df,
          MinEquation: () => r.znC,
          MirroredRepeatWrapping: () => r.kTW,
          MixOperation: () => r.KRh,
          MultiplyBlending: () => r.EdD,
          MultiplyOperation: () => r.caT,
          NearestFilter: () => r.hxR,
          NearestMipMapLinearFilter: () => r.a$r,
          NearestMipMapNearestFilter: () => r.$O9,
          NearestMipmapLinearFilter: () => r.Cfg,
          NearestMipmapNearestFilter: () => r.pHI,
          NeutralToneMapping: () => r.aJ8,
          NeverCompare: () => r.amv,
          NeverDepth: () => r.eHc,
          NeverStencilFunc: () => r.HPb,
          NoBlending: () => r.XIg,
          NoColorSpace: () => r.jf0,
          NoToneMapping: () => r.y_p,
          NormalAnimationBlendMode: () => r.Ke9,
          NormalBlending: () => r.NTi,
          NotEqualCompare: () => r.jzd,
          NotEqualDepth: () => r.bw0,
          NotEqualStencilFunc: () => r.klZ,
          NumberKeyframeTrack: () => r.Hit,
          Object3D: () => r.B69,
          ObjectLoader: () => r.XTe,
          ObjectSpaceNormalMap: () => r.vyJ,
          OctahedronGeometry: () => r.Ufg,
          OneFactor: () => r.qad,
          OneMinusConstantAlphaFactor: () => r.ov9,
          OneMinusConstantColorFactor: () => r.$Yl,
          OneMinusDstAlphaFactor: () => r.Nt7,
          OneMinusDstColorFactor: () => r.aEY,
          OneMinusSrcAlphaFactor: () => r.OuU,
          OneMinusSrcColorFactor: () => r.LiQ,
          OrthographicCamera: () => r.qUd,
          PCFShadowMap: () => r.QP0,
          PCFSoftShadowMap: () => r.Wk7,
          PMREMGenerator: () => P,
          Path: () => r.wAk,
          PerspectiveCamera: () => r.ubm,
          Plane: () => r.Zcv,
          PlaneGeometry: () => r.bdM,
          PlaneHelper: () => r.ZM4,
          PointLight: () => r.HiM,
          PointLightHelper: () => r.F1l,
          Points: () => r.ONl,
          PointsMaterial: () => r.BH$,
          PolarGridHelper: () => r.hzE,
          PolyhedronGeometry: () => r.pFK,
          PositionalAudio: () => r.xZx,
          PropertyBinding: () => r.Nwf,
          PropertyMixer: () => r.N2s,
          QuadraticBezierCurve: () => r.dAo,
          QuadraticBezierCurve3: () => r.CV9,
          Quaternion: () => r.PTz,
          QuaternionKeyframeTrack: () => r.MBL,
          QuaternionLinearInterpolant: () => r.GBG,
          RED_GREEN_RGTC2_Format: () => r.HO_,
          RED_RGTC1_Format: () => r.Kef,
          REVISION: () => r.sPf,
          RGBADepthPacking: () => r.N5j,
          RGBAFormat: () => r.GWd,
          RGBAIntegerFormat: () => r.c90,
          RGBA_ASTC_10x10_Format: () => r.y3Z,
          RGBA_ASTC_10x5_Format: () => r.uB5,
          RGBA_ASTC_10x6_Format: () => r.lyL,
          RGBA_ASTC_10x8_Format: () => r.bC7,
          RGBA_ASTC_12x10_Format: () => r.ojs,
          RGBA_ASTC_12x12_Format: () => r.S$4,
          RGBA_ASTC_4x4_Format: () => r.qa3,
          RGBA_ASTC_5x4_Format: () => r.B_h,
          RGBA_ASTC_5x5_Format: () => r.czI,
          RGBA_ASTC_6x5_Format: () => r.rSH,
          RGBA_ASTC_6x6_Format: () => r.Qrf,
          RGBA_ASTC_8x5_Format: () => r.psI,
          RGBA_ASTC_8x6_Format: () => r.a5J,
          RGBA_ASTC_8x8_Format: () => r._QJ,
          RGBA_BPTC_Format: () => r.Fn,
          RGBA_ETC2_EAC_Format: () => r.KDk,
          RGBA_PVRTC_2BPPV1_Format: () => r.pBf,
          RGBA_PVRTC_4BPPV1_Format: () => r.HXV,
          RGBA_S3TC_DXT1_Format: () => r.Nz6,
          RGBA_S3TC_DXT3_Format: () => r.jR7,
          RGBA_S3TC_DXT5_Format: () => r.BXX,
          RGBDepthPacking: () => r.wTz,
          RGBFormat: () => r.HIg,
          RGBIntegerFormat: () => r.VGF,
          RGB_BPTC_SIGNED_Format: () => r.H23,
          RGB_BPTC_UNSIGNED_Format: () => r.W9U,
          RGB_ETC1_Format: () => r.CVz,
          RGB_ETC2_Format: () => r.Riy,
          RGB_PVRTC_2BPPV1_Format: () => r.kTp,
          RGB_PVRTC_4BPPV1_Format: () => r.k6Q,
          RGB_S3TC_DXT1_Format: () => r.IE4,
          RGDepthPacking: () => r.k8v,
          RGFormat: () => r.paN,
          RGIntegerFormat: () => r.TkQ,
          RawShaderMaterial: () => r.D$Q,
          Ray: () => r.RlV,
          Raycaster: () => r.tBo,
          RectAreaLight: () => r.ure,
          RedFormat: () => r.VT0,
          RedIntegerFormat: () => r.ZQM,
          ReinhardToneMapping: () => r.Mjd,
          RenderTarget: () => r.O0B,
          RenderTarget3D: () => r.XMJ,
          RenderTargetArray: () => r.rrX,
          RepeatWrapping: () => r.GJx,
          ReplaceStencilOp: () => r.kG0,
          ReverseSubtractEquation: () => r.nST,
          RingGeometry: () => r.rKP,
          SIGNED_RED_GREEN_RGTC2_Format: () => r.CWW,
          SIGNED_RED_RGTC1_Format: () => r.XG_,
          SRGBColorSpace: () => r.er$,
          SRGBTransfer: () => r.KLL,
          Scene: () => r.Z58,
          ShaderChunk: () => o,
          ShaderLib: () => s,
          ShaderMaterial: () => r.BKk,
          ShadowMaterial: () => r.q2,
          Shape: () => r.ypk,
          ShapeGeometry: () => r.MSw,
          ShapePath: () => r.Ld9,
          ...
          ShortType: () => r.fBL,
          Skeleton: () => r.EAD,
          SkeletonHelper: () => r._xc,
          SkinnedMesh: () => r.I46,
          Source: () => r.kLi,
          Sphere: () => r.iyt,
          SphereGeometry: () => r.Gu$,
          Spherical: () => r.YHV,
          SphericalHarmonics3: () => r.xOk,
          SplineCurve: () => r.xfg,
          SpotLight: () => r.nCl,
          SpotLightHelper: () => r.Fpm,
          Sprite: () => r.kxk,
          SpriteMaterial: () => r.RoJ,
          SrcAlphaFactor: () => r.ie2,
          SrcAlphaSaturateFactor: () => r.hgQ,
          SrcColorFactor: () => r.f4X,
          StaticCopyUsage: () => r.Hrq,
          StaticDrawUsage: () => r.agE,
          StaticReadUsage: () => r.uXQ,
          StereoCamera: () => r.keZ,
          StreamCopyUsage: () => r.rOG,
          StreamDrawUsage: () => r.Ktl,
          StreamReadUsage: () => r.uov,
          StringKeyframeTrack: () => r.hZF,
          SubtractEquation: () => r.FXf,
          SubtractiveBlending: () => r.Kwu,
          TOUCH: () => r.wtR,
          TangentSpaceNormalMap: () => r.bI3,
          TetrahedronGeometry: () => r.Zpd,
          Texture: () => r.gPd,
          TextureLoader: () => r.Tap,
          TextureUtils: () => r.Vwu,
          TimestampQuery: () => r.v9J,
          TorusGeometry: () => r.O3Y,
          TorusKnotGeometry: () => r.UPV,
          Triangle: () => r.lMl,
          TriangleFanDrawMode: () => r.rYR,
          TriangleStripDrawMode: () => r.O49,
          TrianglesDrawMode: () => r.RJ4,
          TubeGeometry: () => r.j6,
          UVMapping: () => r.UTZ,
          Uint16BufferAttribute: () => r.A$4,
          Uint32BufferAttribute: () => r.MW4,
          Uint8BufferAttribute: () => r.baL,
          Uint8ClampedBufferAttribute: () => r.fc6,
          Uniform: () => r.nc$,
          UniformsGroup: () => r.dzP,
          UniformsLib: () => l,
          UniformsUtils: () => r.LlO,
          UnsignedByteType: () => r.OUM,
          UnsignedInt248Type: () => r.V3x,
          UnsignedInt5999Type: () => r.Dmk,
          UnsignedIntType: () => r.bkx,
          UnsignedShort4444Type: () => r.Wew,
          UnsignedShort5551Type: () => r.gJ2,
          UnsignedShortType: () => r.cHt,
          VSMShadowMap: () => r.RyA,
          Vector2: () => r.I9Y,
          Vector3: () => r.Pq0,
          Vector4: () => r.IUQ,
          VectorKeyframeTrack: () => r.RiT,
          VideoFrameTexture: () => r.SYV,
          VideoTexture: () => r.Nv2,
          WebGL3DRenderTarget: () => r.ALV,
          WebGLArrayRenderTarget: () => r.y9J,
          WebGLCoordinateSystem: () => r.TdN,
          WebGLCubeRenderTarget: () => r.o6l,
          WebGLRenderTarget: () => r.nWS,
          WebGLRenderer: () => nb,
          WebGLUtils: () => nv,
          WebGPUCoordinateSystem: () => r.i7u,
          WebXRController: () => r.R3r,
          WireframeGeometry: () => r.XJ7,
          WrapAroundEnding: () => r.dhZ,
          ZeroCurvatureEnding: () => r.rQf,
          ZeroFactor: () => r.ojh,
          ZeroSlopeEnding: () => r.h2z,
          ZeroStencilOp: () => r.kqe,
          createCanvasElement: () => r.lPF,
        });
      var r = t(3264);
      function i() {
        let e = null,
          ...
          r = null;
        function i(n, a) {
          t(n, a), (r = e.requestAnimationFrame(i));
        }
        return {
          start: function () {
            !0 !== n &&
              null !== t &&
              ((r = e.requestAnimationFrame(i)), (n = !0));
          },
          stop: function () {
      ...
      function a(e) {
        ...
        return {
          ...
          update: function (t, r) {
            ...
            if (void 0 === i)
            ...
            else if (i.version < t.version) {
              if (i.size !== t.array.byteLength)
                throw Error(
              ...
              !(function (n, t, r) {
                let i = t.array,
                  a = t.updateRanges;
                if ((e.bindBuffer(r, n), 0 === a.length))
                  ...
                  for (let e = 1; e < a.length; e++) {
                    let t = a[n],
                      r = a[e];
                    r.start <= t.start + t.count + 1
                      ? (t.count = Math.max(
                          t.count,
                          r.start + r.count - t.start
                        ))
                      : (a[++n] = r);
                  }
                  a.length = n + 1;
      ...
      let o = {
        ...
        l = {
          common: {
            diffuse: { value: new r.Q1f(0xffffff) },
            opacity: { value: 1 },
            map: { value: null },
            mapTransform: { value: new r.dwI() },
            alphaMap: { value: null },
            alphaMapTransform: { value: new r.dwI() },
            alphaTest: { value: 0 },
          },
          specularmap: {
            specularMap: { value: null },
            specularMapTransform: { value: new r.dwI() },
          },
          envmap: {
            envMap: { value: null },
            envMapRotation: { value: new r.dwI() },
            flipEnvMap: { value: -1 },
          ...
          aomap: {
            ...
            aoMapTransform: { value: new r.dwI() },
          },
          lightmap: {
            lightMap: { value: null },
            lightMapIntensity: { value: 1 },
            lightMapTransform: { value: new r.dwI() },
          },
          bumpmap: {
            bumpMap: { value: null },
            bumpMapTransform: { value: new r.dwI() },
            bumpScale: { value: 1 },
          },
          normalmap: {
            normalMap: { value: null },
            normalMapTransform: { value: new r.dwI() },
            normalScale: { value: new r.I9Y(1, 1) },
          },
          displacementmap: {
            displacementMap: { value: null },
            displacementMapTransform: { value: new r.dwI() },
            displacementScale: { value: 1 },
            displacementBias: { value: 0 },
          },
          emissivemap: {
            emissiveMap: { value: null },
            emissiveMapTransform: { value: new r.dwI() },
          },
          metalnessmap: {
            metalnessMap: { value: null },
            metalnessMapTransform: { value: new r.dwI() },
          },
          roughnessmap: {
            roughnessMap: { value: null },
            roughnessMapTransform: { value: new r.dwI() },
          },
          ...
          fog: {
            ...
            fogNear: { value: 1 },
            fogFar: { value: 2e3 },
            fogColor: { value: new r.Q1f(0xffffff) },
          },
          lights: {
          ...
          points: {
            ...
            alphaMapTransform: { value: new r.dwI() },
            alphaTest: { value: 0 },
            uvTransform: { value: new r.dwI() },
          },
          sprite: {
            diffuse: { value: new r.Q1f(0xffffff) },
            opacity: { value: 1 },
            center: { value: new r.I9Y(0.5, 0.5) },
            rotation: { value: 0 },
            map: { value: null },
            mapTransform: { value: new r.dwI() },
            alphaMap: { value: null },
        ...
        s = {
          ...
          phong: {
            uniforms: (0, r.Iit)([
              ...
              {
                emissive: { value: new r.Q1f(0) },
                specular: { value: new r.Q1f(1118481) },
                shininess: { value: 30 },
              },
            ]),
          ...
          points: {
            uniforms: (0, r.Iit)([l.points, l.fog]),
          ...
          depth: {
            uniforms: (0, r.Iit)([l.common, l.displacementmap]),
          ...
          sprite: {
            uniforms: (0, r.Iit)([l.sprite, l.fog]),
          ...
          backgroundCube: {
            uniforms: {
              ...
              backgroundIntensity: { value: 1 },
              backgroundRotation: { value: new r.dwI() },
            },
          ...
          distanceRGBA: {
            uniforms: (0, r.Iit)([
              ...
              l.displacementmap,
              {
                referencePosition: { value: new r.Pq0() },
          ...
          shadow: {
            uniforms: (0, r.Iit)([
              l.lights,
              l.fog,
              { color: { value: new r.Q1f(0) }, opacity: { value: 1 } },
            ]),
      ...
      s.physical = {
        uniforms: (0, r.Iit)([
          s.standard.uniforms,
          {
            ...
            clearcoatMapTransform: { value: new r.dwI() },
            clearcoatNormalMap: { value: null },
            clearcoatNormalMapTransform: { value: new r.dwI() },
            clearcoatNormalScale: { value: new r.I9Y(1, 1) },
            clearcoatRoughness: { value: 0 },
            clearcoatRoughnessMap: { value: null },
            clearcoatRoughnessMapTransform: { value: new r.dwI() },
            dispersion: { value: 0 },
            iridescence: { value: 0 },
            iridescenceMap: { value: null },
            iridescenceMapTransform: { value: new r.dwI() },
            iridescenceIOR: { value: 1.3 },
            iridescenceThicknessMinimum: { value: 100 },
            iridescenceThicknessMaximum: { value: 400 },
            iridescenceThicknessMap: { value: null },
            iridescenceThicknessMapTransform: { value: new r.dwI() },
            sheen: { value: 0 },
            sheenColor: { value: new r.Q1f(0) },
            sheenColorMap: { value: null },
            sheenColorMapTransform: { value: new r.dwI() },
            sheenRoughness: { value: 1 },
            sheenRoughnessMap: { value: null },
            sheenRoughnessMapTransform: { value: new r.dwI() },
            transmission: { value: 0 },
            transmissionMap: { value: null },
            transmissionMapTransform: { value: new r.dwI() },
            transmissionSamplerSize: { value: new r.I9Y() },
            transmissionSamplerMap: { value: null },
            thickness: { value: 0 },
            thicknessMap: { value: null },
            thicknessMapTransform: { value: new r.dwI() },
            attenuationDistance: { value: 0 },
            attenuationColor: { value: new r.Q1f(0) },
            specularColor: { value: new r.Q1f(1, 1, 1) },
            specularColorMap: { value: null },
            specularColorMapTransform: { value: new r.dwI() },
            specularIntensity: { value: 1 },
            specularIntensityMap: { value: null },
            specularIntensityMapTransform: { value: new r.dwI() },
            anisotropyVector: { value: new r.I9Y() },
            anisotropyMap: { value: null },
            anisotropyMapTransform: { value: new r.dwI() },
          },
        ]),
        vertexShader: o.meshphysical_vert,
        fragmentShader: o.meshphysical_frag,
      ...
      function f(e, n, t, i, a, o, l) {
        ...
        function E(e) {
          ...
          return (
            r &&
              r.isTexture &&
              (r = (e.backgroundBlurriness > 0 ? t : n).get(r)),
            r
          );
        }
        function S(n, t) {
          n.getRGB(c, (0, r._Ut)(e)),
            i.buffers.color.setClear(c.r, c.g, c.b, t, l);
        }
        return {
          ...
          render: function (n) {
            let t = !1,
              r = E(n);
            null === r ? S(m, h) : r && r.isColor && (S(r, 1), (t = !0));
            let a = e.xr.getEnvironmentBlendMode();
            "additive" === a
              ? i.buffers.color.setClear(0, 0, 0, 1, l)
              : "alpha-blend" === a && i.buffers.color.setClear(0, 0, 0, 0, l),
              (e.autoClear || t) &&
          ...
          addToRenderList: function (n, t) {
            let i = E(t);
            i && (i.isCubeTexture || i.mapping === r.Om)
              ? (void 0 === p &&
                  ((p = new r.eaF(
                    new r.iNn(1, 1, 1),
                    new r.BKk({
                      name: "BackgroundCubeMaterial",
                      uniforms: (0, r.lxW)(s.backgroundCube.uniforms),
                ...
                i.isCubeTexture &&
                  ...
                  ((d.y *= -1), (d.z *= -1)),
                (p.material.uniforms.envMap.value = i),
                ...
                (p.material.toneMapped =
                  r.ppV.getTransfer(i.colorSpace) !== r.KLL),
                (_ !== i || g !== i.version || v !== e.toneMapping) &&
                ...
                (void 0 === f &&
                  ((f = new r.eaF(
                    ...
                    new r.BKk({
                      ...
                      uniforms: (0, r.lxW)(s.background.uniforms),
                  ...
                  a.update(f)),
                (f.material.uniforms.t2D.value = i),
                (f.material.uniforms.backgroundIntensity.value =
                  t.backgroundIntensity),
                (f.material.toneMapped =
                  r.ppV.getTransfer(i.colorSpace) !== r.KLL),
                !0 === i.matrixAutoUpdate && i.updateMatrix(),
                f.material.uniforms.uvTransform.value.copy(i.matrix),
                (_ !== i || g !== i.version || v !== e.toneMapping) &&
          ...
          dispose: function () {
            void 0 !== p &&
              ...
              void 0 !== f &&
                (f.geometry.dispose(), f.material.dispose(), (f = void 0));
          },
        };
      }
      function p(e, n) {
        ...
        function d(e) {
          let n = [],
            r = [],
            i = [];
          for (let e = 0; e < t; e++) (n[e] = 0), (r[e] = 0), (i[e] = 0);
          return {
            geometry: null,
            program: null,
            wireframe: !1,
        ...
        function m() {
          ...
          for (let r = 0, i = t.length; r < i; r++)
            t[r] !== n[r] && (e.disableVertexAttribArray(r), (t[r] = 0));
        }
        function h(n, t, r, i, a, o, l) {
          !0 === l
            ? e.vertexAttribIPointer(n, t, r, a, o)
            : e.vertexAttribPointer(n, t, r, i, a, o);
        }
        function _() {
        ...
        return {
          setup: function (t, a, c, _, g) {
            ...
            o !== E && s((o = E).object),
              (v = (function (e, n, t, r) {
                ...
                return o.attributesNum !== l || o.index !== r;
              })(t, _, c, g)) &&
                (function (e, n, t, r) {
                  let i = {},
                    a = n.attributes,
                  ...
                  for (let n in s)
                    if (s[n].location >= 0) {
                      ...
                      let r = {};
                      (r.attribute = t),
                        t && t.data && (r.data = t.data),
                        (i[n] = r),
                        l++;
                    }
                  (o.attributes = i), (o.attributesNum = l), (o.index = r);
                })(t, _, c, g),
          ...
          releaseStatesOfProgram: function (e) {
            for (let n in i) {
              ...
              let r = t[e.id];
              for (let e in r) c(r[e].object), delete r[e];
              delete t[e.id];
            }
          },
          initAttributes: u,
      ...
      function m(e, n, t) {
        let r;
        function i(n, i, a) {
          0 !== a && (e.drawArraysInstanced(r, n, i, a), t.update(i, r, a));
        }
        (this.setMode = function (e) {
          r = e;
        }),
          (this.render = function (n, i) {
            e.drawArrays(r, n, i), t.update(i, r, 1);
          }),
          (this.renderInstances = i),
          (this.renderMultiDraw = function (e, i, a) {
            if (0 === a) return;
            n.get("WEBGL_multi_draw").multiDrawArraysWEBGL(r, e, 0, i, 0, a);
            let o = 0;
          ...
          (this.renderMultiDrawInstances = function (e, a, o, l) {
            ...
            if (null === s)
              for (let n = 0; n < e.length; n++) i(e[n], a[n], l[n]);
            else {
              s.multiDrawArraysInstancedWEBGL(r, e, 0, a, 0, l, 0, o);
              let n = 0;
      ...
      function _(e) {
        ...
        function d(e, t, r, i) {
          ...
          if (0 !== a) {
            if (((o = c.value), !0 !== i || null === o)) {
              ...
              for (let n = 0, t = r; n !== a; ++n, t += 4)
                l.copy(e[n]).applyMatrix4(i, s),
        ...
        (this.uniform = c),
          ...
          (this.init = function (e, n) {
            let t = 0 !== e.length || n || 0 !== i || a;
            return (a = n), (i = e.length), t;
          }),
          ...
          (this.setState = function (r, l, s) {
            let u = r.clippingPlanes,
              f = r.clipIntersection,
              p = r.clipShadows,
              m = e.get(r);
      ...
      class P {
        ...
        fromScene(e, n = 0, t = 0.1, r = 100, i = {}) {
          let { size: a = 256, position: o = L } = i;
        ...
        _cleanup(e) {
          this._renderer.setRenderTarget(T, M, x),
            ...
            (e.scissorTest = !1),
            D(e, 0, 0, e.width, e.height);
        }
        _fromTexture(e, n) {
          e.mapping === r.hy7 || e.mapping === r.xFO
            ? this._setSize(
                0 === e.image.length
                  ? 16
        ...
        _allocateTargets() {
          ...
          if (
            ...
            null !== this._pingPongRenderTarget && this._dispose(),
              (this._pingPongRenderTarget = U(e, n, t));
            let { _lodMax: i } = this;
            ({
              ...
              for (let l = 0; l < o; l++) {
                ...
                for (let e = 0; e < 6; e++) {
                  ...
                  p.set(r, 18 * e), m.set(f, 12 * e);
                  let i = [e, e, e, e, e, e];
                  h.set(i, 6 * e);
                }
                let _ = new r.LoY();
                _.setAttribute("position", new r.THS(p, 3)),
                  _.setAttribute("uv", new r.THS(m, 2)),
                  _.setAttribute("faceIndex", new r.THS(h, 1)),
                  n.push(_),
                  a > 4 && a--;
              }
        ...
        _compileMaterial(e) {
          let n = new r.eaF(this._lodPlanes[0], e);
          this._renderer.compile(n, E);
        }
        _sceneToCubeUV(e, n, t, i, a) {
          let o = new r.ubm(90, 1, n, t),
            l = [1, -1, 1, 1, 1, 1],
            s = [1, 1, 1, -1, -1, -1],
            c = this._renderer,
            d = c.autoClear,
            u = c.toneMapping;
          c.getClearColor(S), (c.toneMapping = r.y_p), (c.autoClear = !1);
          let f = new r.V9B({
          ...
          for (let n = 0; n < 6; n++) {
            ...
            0 === t
              ? (o.up.set(0, l[n], 0),
                ...
                o.lookAt(a.x + s[n], a.y, a.z))
              : 1 === t
              ? (o.up.set(0, 0, l[n]),
                o.position.set(a.x, a.y, a.z),
                o.lookAt(a.x, a.y + s[n], a.z))
              : (o.up.set(0, l[n], 0),
                o.position.set(a.x, a.y, a.z),
                o.lookAt(a.x, a.y, a.z + s[n]));
        ...
        _textureToCubeUV(e, n) {
          let t = this._renderer,
            i = e.mapping === r.hy7 || e.mapping === r.xFO;
          i
            ? (null === this._cubemapMaterial && (this._cubemapMaterial = I()),
              (this._cubemapMaterial.uniforms.flipEnvMap.value =
                !1 === e.isRenderTargetTexture ? -1 : 1))
            : null === this._equirectMaterial && (this._equirectMaterial = w());
          let a = i ? this._cubemapMaterial : this._equirectMaterial,
            o = new r.eaF(this._lodPlanes[0], a);
          a.uniforms.envMap.value = e;
          let l = this._cubeSize;
          D(n, 0, 0, 3 * l, 2 * l), t.setRenderTarget(n), t.render(o, E);
        }
        _applyPMREM(e) {
        ...
        _blur(e, n, t, r, i) {
          ...
          this._halfBlur(e, a, n, t, r, "latitudinal", i),
            this._halfBlur(a, e, t, t, r, "longitudinal", i);
        }
        _halfBlur(e, n, t, i, a, o, l) {
          ...
          let d = new r.eaF(this._lodPlanes[i], c),
            u = c.uniforms,
          ...
          D(n, 3 * S * (i > v - 4 ? i - v + 4 : 0), T, 3 * S, 2 * S),
            s.setRenderTarget(n),
            s.render(d, E);
        }
      }
      ...
      function D(e, n, t, r, i) {
        e.viewport.set(n, t, r, i), e.scissor.set(n, t, r, i);
      }
      function w() {
        return new r.BKk({
	...
	`;
        ...
        return {
          get: function (a) {
            if (a && a.isTexture) {
              ...
              if (l || s) {
                let r = n.get(a),
                  o = void 0 !== r ? r.texture.pmremVersion : 0;
                if (a.isRenderTargetTexture && a.pmremVersion !== o)
                  return (
                    null === t && (t = new P(e)),
                    ((r = l
                      ? t.fromEquirectangular(a, r)
                      : t.fromCubemap(a, r)).texture.pmremVersion =
                      a.pmremVersion),
                    n.set(a, r),
                    r.texture
                  );
      ...
      function F(e, n, t, i) {
        ...
        function l(e) {
          let r = e.target;
          for (let e in (null !== r.index && n.remove(r.index), r.attributes))
            n.remove(r.attributes[e]);
          r.removeEventListener("dispose", l), delete a[r.id];
          let s = o.get(r);
          s && (n.remove(s), o.delete(r)),
            i.releaseStatesOfGeometry(r),
        ...
        function s(e) {
          ...
          if (null !== i) {
            ...
            let e = a.array;
            l = a.version;
            for (let n = 0, r = e.length / 3 - 1; n < r; n += 3) {
              let e = n + 0,
                r = n + 1,
                i = n + 2;
              t.push(e, r, r, i, i, e);
          ...
          let s = new ((0, r.AQS)(t) ? r.MW4 : r.A$4)(t, 1);
          s.version = l;
          let c = o.get(e);
        ...
        return {
          ...
          update: function (t) {
            let r = t.attributes;
            for (let t in r) n.update(r[t], e.ARRAY_BUFFER);
          },
      ...
      function B(e, n, t) {
        ...
        function o(n, o, l) {
          0 !== l &&
            (e.drawElementsInstanced(r, o, i, n * a, l), t.update(o, r, l));
        }
        (this.setMode = function (e) {
          r = e;
        }),
          ...
          (this.render = function (n, o) {
            e.drawElements(r, o, i, n * a), t.update(o, r, 1);
          }),
          ...
          (this.renderMultiDrawInstances = function (e, l, s, c) {
            ...
            if (null === d)
              ...
              d.multiDrawElementsInstancedWEBGL(r, l, 0, i, e, 0, c, 0, s);
              let n = 0;
        ...
        return {
          update: function (o, l, s) {
            ...
            if (void 0 === f || f.count !== u) {
              ...
              (f = { count: u, texture: g, size: new r.I9Y(m, h) }),
                i.set(l, f),
                l.addEventListener("dispose", function e() {
                  g.dispose(), i.delete(l), l.removeEventListener("dispose", e);
                });
            }
        ...
        return {
          update: function (o) {
            let l = r.render.frame,
              ...
              c = n.get(o, s);
            if (
              (i.get(c) !== l && (n.update(c), i.set(c, l)),
              o.isInstancedMesh &&
      ...
      function $(e, n, t) {
        ...
        let i = n * t,
          a = q[i];
        if (
          (void 0 === a && ((a = new Float32Array(i)), (q[i] = a)), 0 !== n)
        ) {
          r.toArray(a, 0);
          for (let r = 1, i = 0; r !== n; ++r) (i += t), e[r].toArray(a, i);
        }
        return a;
      }
      function J(e, n) {
        if (e.length !== n.length) return !1;
        for (let t = 0, r = e.length; t < r; t++) if (e[t] !== n[t]) return !1;
        return !0;
      }
      function ee(e, n) {
      ...
      function en(e, n) {
        let t = Y[n];
        void 0 === t && ((t = new Int32Array(n)), (Y[n] = t));
        for (let r = 0; r !== n; ++r) t[r] = e.allocateTextureUnit();
        return t;
      }
      function et(e, n) {
        let t = this.cache;
      ...
      function er(e, n) {
        ...
        if (void 0 !== n.x)
          ...
          if (J(t, n)) return;
          e.uniform2fv(this.addr, n), ee(t, n);
        }
      }
      function ei(e, n) {
        let t = this.cache;
        if (void 0 !== n.x)
          ...
          if (J(t, n)) return;
          e.uniform3fv(this.addr, n), ee(t, n);
        }
      }
      function ea(e, n) {
        let t = this.cache;
        if (void 0 !== n.x)
          ...
          if (J(t, n)) return;
          e.uniform4fv(this.addr, n), ee(t, n);
        }
      }
      function eo(e, n) {
        let t = this.cache,
        ...
        if (void 0 === r) {
          if (J(t, n)) return;
          e.uniformMatrix2fv(this.addr, !1, n), ee(t, n);
        } else {
          if (J(t, r)) return;
          Z.set(r), e.uniformMatrix2fv(this.addr, !1, Z), ee(t, r);
        }
      }
      function el(e, n) {
        let t = this.cache,
        ...
        if (void 0 === r) {
          if (J(t, n)) return;
          e.uniformMatrix3fv(this.addr, !1, n), ee(t, n);
        } else {
          if (J(t, r)) return;
          Q.set(r), e.uniformMatrix3fv(this.addr, !1, Q), ee(t, r);
        }
      }
      function es(e, n) {
        let t = this.cache,
        ...
        if (void 0 === r) {
          if (J(t, n)) return;
          e.uniformMatrix4fv(this.addr, !1, n), ee(t, n);
        } else {
          if (J(t, r)) return;
          j.set(r), e.uniformMatrix4fv(this.addr, !1, j), ee(t, r);
        }
      }
      function ec(e, n) {
        let t = this.cache;
      ...
      function ed(e, n) {
        ...
        if (void 0 !== n.x)
          ...
          if (J(t, n)) return;
          e.uniform2iv(this.addr, n), ee(t, n);
        }
      }
      function eu(e, n) {
        let t = this.cache;
        if (void 0 !== n.x)
          ...
          if (J(t, n)) return;
          e.uniform3iv(this.addr, n), ee(t, n);
        }
      }
      function ef(e, n) {
        let t = this.cache;
        if (void 0 !== n.x)
          ...
          if (J(t, n)) return;
          e.uniform4iv(this.addr, n), ee(t, n);
        }
      }
      function ep(e, n) {
        let t = this.cache;
      ...
      function em(e, n) {
        ...
        if (void 0 !== n.x)
          ...
          if (J(t, n)) return;
          e.uniform2uiv(this.addr, n), ee(t, n);
        }
      }
      function eh(e, n) {
        let t = this.cache;
        if (void 0 !== n.x)
          ...
          if (J(t, n)) return;
          e.uniform3uiv(this.addr, n), ee(t, n);
        }
      }
      function e_(e, n) {
        let t = this.cache;
        if (void 0 !== n.x)
          ...
          if (J(t, n)) return;
          e.uniform4uiv(this.addr, n), ee(t, n);
        }
      }
      function eg(e, n, t) {
        let i,
        ...
        a[0] !== o && (e.uniform1i(this.addr, o), (a[0] = o)),
          this.type === e.SAMPLER_2D_SHADOW
            ? ((z.compareFunction = r.TiK), (i = z))
            : (i = k),
          t.setTexture2D(n || i, o);
      }
      function ev(e, n, t) {
        let r = this.cache,
          i = t.allocateTextureUnit();
        r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)),
          t.setTexture3D(n || X, i);
      }
      function eE(e, n, t) {
        let r = this.cache,
          i = t.allocateTextureUnit();
        r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)),
          t.setTextureCube(n || K, i);
      }
      function eS(e, n, t) {
        let r = this.cache,
          i = t.allocateTextureUnit();
        r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)),
          t.setTexture2DArray(n || W, i);
      }
      function eT(e, n) {
      ...
      function eO(e, n, t) {
        let r = this.cache,
          i = n.length,
          a = en(t, i);
        J(r, a) || (e.uniform1iv(this.addr, a), ee(r, a));
        for (let e = 0; e !== i; ++e) t.setTexture2D(n[e] || k, a[e]);
      }
      function eF(e, n, t) {
        let r = this.cache,
          i = n.length,
          a = en(t, i);
        J(r, a) || (e.uniform1iv(this.addr, a), ee(r, a));
        for (let e = 0; e !== i; ++e) t.setTexture3D(n[e] || X, a[e]);
      }
      function eB(e, n, t) {
        let r = this.cache,
          i = n.length,
          a = en(t, i);
        J(r, a) || (e.uniform1iv(this.addr, a), ee(r, a));
        for (let e = 0; e !== i; ++e) t.setTextureCube(n[e] || K, a[e]);
      }
      function eG(e, n, t) {
        let r = this.cache,
          i = n.length,
          a = en(t, i);
        J(r, a) || (e.uniform1iv(this.addr, a), ee(r, a));
        for (let e = 0; e !== i; ++e) t.setTexture2DArray(n[e] || W, a[e]);
      }
      class eH {
        constructor(e, n, t) {
          (this.id = e),
      ...
      class eX {
        constructor(e, n) {
          ...
          for (let r = 0; r < t; ++r) {
            let t = e.getActiveUniform(n, r),
              i = e.getUniformLocation(n, t.name);
            !(function (e, n, t) {
              let r = e.name,
                i = r.length;
              for (ez.lastIndex = 0; ; ) {
                let a = ez.exec(r),
                  ...
                  c = a[3];
                if (
                  (s && (l |= 0), void 0 === c || ("[" === c && o + 2 === i))
                ) {
                  eW(t, void 0 === c ? new eH(l, e, n) : new eV(l, e, n));
                  break;
                }
                {
                  let e = t.map[l];
                  void 0 === e && eW(t, (e = new ek(l))), (t = e);
                }
              }
            })(t, i, this);
          }
        ...
        setValue(e, n, t, r) {
          let i = this.map[n];
          void 0 !== i && i.setValue(e, t, r);
        }
        setOptional(e, n, t) {
          let r = n[t];
          void 0 !== r && this.setValue(e, t, r);
        }
        static upload(e, n, t, r) {
      ...
      let eq = 0,
        eY = new r.dwI();
      function ej(e, n, t) {
        let r = e.getShaderParameter(n, e.COMPILE_STATUS),
          i = e.getShaderInfoLog(n).trim();
        if (r && "" === i) return "";
      ...
      function e8(e, n, t, i) {
        let a,
          ...
          _ =
            ...
            t.shadowMapType === r.QP0
              ? (d = "SHADOWMAP_TYPE_PCF")
              : t.shadowMapType === r.Wk7
              ? (d = "SHADOWMAP_TYPE_PCF_SOFT")
              : t.shadowMapType === r.RyA && (d = "SHADOWMAP_TYPE_VSM"),
            d),
          g = (function (e) {
        ...
        t.isRawShaderMaterial
          ...
          : ((a = [
            ...
            (l = [
              ...
              "uniform vec3 cameraPosition;",
              "uniform bool isOrthographic;",
              t.toneMapping !== r.y_p ? "#define TONE_MAPPING" : "",
              t.toneMapping !== r.y_p ? o.tonemapping_pars_fragment : "",
              t.toneMapping !== r.y_p
                ? (function (e, n) {
                    let t;
                    switch (n) {
              ...
              (function (e, n) {
                let t = (function (e) {
                  r.ppV._getMatrix(eY, r.ppV.workingColorSpace, e);
                  let n = `mat3( ${eY.elements.map((e) => e.toFixed(4))} )`;
                  switch (r.ppV.getTransfer(e)) {
                    case r.VxR:
	...
	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );
              ...
              (function () {
                r.ppV.getLuminanceCoefficients(eQ);
                let e = eQ.x.toFixed(4),
                  n = eQ.y.toFixed(4),
                  t = eQ.z.toFixed(4);
	...
	return dot( weights, rgb );
        ...
        let A = R + a + m,
          C = R + l + h,
          b = eK(f, f.VERTEX_SHADER, A),
          L = eK(f, f.FRAGMENT_SHADER, C);
        function P(n) {
          if (e.debug.checkShaderErrors) {
            let t = f.getProgramInfoLog(x).trim(),
              r = f.getShaderInfoLog(b).trim(),
              i = f.getShaderInfoLog(L).trim(),
              o = !0,
              s = !0;
            if (!1 === f.getProgramParameter(x, f.LINK_STATUS))
              if (((o = !1), "function" == typeof e.debug.onShaderError))
                e.debug.onShaderError(f, x, b, L);
              else {
                let e = ej(f, b, "vertex"),
                  r = ej(f, L, "fragment");
                console.error(
          ...
          f.deleteShader(b),
            ...
            (c = (function (e, n) {
              let t = {},
                r = e.getProgramParameter(n, e.ACTIVE_ATTRIBUTES);
              for (let i = 0; i < r; i++) {
                let r = e.getActiveAttrib(n, i),
                  a = r.name,
                  o = 1;
      ...
      class ne {
        ...
        _getShaderStage(e) {
          let n = this.shaderCache,
            t = n.get(e);
          return void 0 === t && ((t = new nn(e)), n.set(e, t)), t;
        }
      }
      class nn {
        constructor(e) {
          (this.id = e7++), (this.code = e), (this.usedTimes = 0);
        }
      }
      function nt(e, n, t, i, a, o, l) {
        let c = new r.zgK(),
          d = new ne(),
          u = new Set(),
          f = [],
        ...
        return {
          getParameters: function (o, c, f, v, E) {
            let S,
              ...
              R = v.fog,
              A = E.geometry,
              C = o.isMeshStandardMaterial ? v.environment : null,
              b = (o.isMeshStandardMaterial ? t : n).get(o.envMap || C),
              L = b && b.mapping === r.Om ? b.image.height : null,
              P = _[o.type];
            null !== o.precision &&
            ...
            let U =
              ...
              w = 0;
            if (
              (void 0 !== A.morphAttributes.position && (w = 1),
              void 0 !== A.morphAttributes.normal && (w = 2),
              void 0 !== A.morphAttributes.color && (w = 3),
              P)
            ) {
              let e = s[P];
            ...
            let I = e.getRenderTarget(),
              ...
              $ = o.sheen > 0,
              J = o.transmission > 0,
              ee = Y && !!o.anisotropyMap,
              en = j && !!o.clearcoatMap,
              et = j && !!o.clearcoatNormalMap,
              er = j && !!o.clearcoatRoughnessMap,
              ei = Z && !!o.iridescenceMap,
            ...
            let eE = {
              ...
              displacementMap: m && W,
              emissiveMap: X,
              normalMapObjectSpace: z && o.normalMapType === r.vyJ,
              normalMapTangentSpace: z && o.normalMapType === r.bI3,
              metalnessMap: K,
              roughnessMap: q,
              anisotropy: Y,
              anisotropyMap: ee,
              ...
              metalnessMapUv: K && g(o.metalnessMap.channel),
              ...
              clearcoatRoughnessMapUv: er && g(o.clearcoatRoughnessMap.channel),
              iridescenceMapUv: ei && g(o.iridescenceMap.channel),
              ...
              vertexTangents: !!A.attributes.tangent && (z || Y),
              ...
              decodeVideoTexture:
                ...
                r.ppV.getTransfer(o.map.colorSpace) === r.KLL,
              decodeVideoTextureEmissive:
                X &&
                !0 === o.emissiveMap.isVideoTexture &&
                r.ppV.getTransfer(o.emissiveMap.colorSpace) === r.KLL,
              premultipliedAlpha: o.premultipliedAlpha,
              doubleSided: o.side === r.$EB,
              flipSided: o.side === r.hsX,
          ...
          getProgramCacheKey: function (n) {
            ...
            if (
              (n.shaderID
                ? o.push(n.shaderID)
                : (o.push(n.customVertexShaderID),
                  o.push(n.customFragmentShaderID)),
              void 0 !== n.defines)
            )
              for (let e in n.defines) o.push(e), o.push(n.defines[e]);
            return (
              !1 === n.isRawShaderMaterial &&
                ...
                t.push(r.envMapMode),
                t.push(r.envMapCubeUVHeight),
                t.push(r.mapUv),
                t.push(r.alphaMapUv),
                t.push(r.lightMapUv),
                t.push(r.aoMapUv),
                t.push(r.bumpMapUv),
                t.push(r.normalMapUv),
                t.push(r.displacementMapUv),
                t.push(r.emissiveMapUv),
                t.push(r.metalnessMapUv),
                t.push(r.roughnessMapUv),
                t.push(r.anisotropyMapUv),
                t.push(r.clearcoatMapUv),
                t.push(r.clearcoatNormalMapUv),
                t.push(r.clearcoatRoughnessMapUv),
                t.push(r.iridescenceMapUv),
                t.push(r.iridescenceThicknessMapUv),
                t.push(r.sheenColorMapUv),
                t.push(r.sheenRoughnessMapUv),
                t.push(r.specularMapUv),
                t.push(r.specularColorMapUv),
                t.push(r.specularIntensityMapUv),
                t.push(r.transmissionMapUv),
                t.push(r.thicknessMapUv),
                t.push(r.combine),
                t.push(r.fogExp2),
                t.push(r.sizeAttenuation),
                t.push(r.morphTargetsCount),
                t.push(r.morphAttributeCount),
                t.push(r.numDirLights),
                t.push(r.numPointLights),
                t.push(r.numSpotLights),
                t.push(r.numSpotLightMaps),
                t.push(r.numHemiLights),
                t.push(r.numRectAreaLights),
                t.push(r.numDirLightShadows),
                t.push(r.numPointLightShadows),
                t.push(r.numSpotLightShadows),
                t.push(r.numSpotLightShadowsWithMaps),
                t.push(r.numLightProbes),
                t.push(r.shadowMapType),
                t.push(r.toneMapping),
                t.push(r.numClippingPlanes),
                t.push(r.numClipIntersection),
                t.push(r.depthPacking),
                (i = o),
                (a = n),
                c.disableAll(),
                a.supportsVertexTextures && c.enable(0),
                a.instancing && c.enable(1),
                a.instancingColor && c.enable(2),
                a.instancingMorph && c.enable(3),
                a.matcap && c.enable(4),
                a.envMap && c.enable(5),
                a.normalMapObjectSpace && c.enable(6),
                a.normalMapTangentSpace && c.enable(7),
                a.clearcoat && c.enable(8),
                a.iridescence && c.enable(9),
                a.alphaTest && c.enable(10),
                a.vertexColors && c.enable(11),
                a.vertexAlphas && c.enable(12),
                a.vertexUv1s && c.enable(13),
                a.vertexUv2s && c.enable(14),
                a.vertexUv3s && c.enable(15),
                a.vertexTangents && c.enable(16),
                a.anisotropy && c.enable(17),
                a.alphaHash && c.enable(18),
                a.batching && c.enable(19),
                a.dispersion && c.enable(20),
                a.batchingColor && c.enable(21),
                i.push(c.mask),
                c.disableAll(),
                a.fog && c.enable(0),
                a.useFog && c.enable(1),
                a.flatShading && c.enable(2),
                a.logarithmicDepthBuffer && c.enable(3),
                a.reverseDepthBuffer && c.enable(4),
                a.skinning && c.enable(5),
                a.morphTargets && c.enable(6),
                a.morphNormals && c.enable(7),
                a.morphColors && c.enable(8),
                a.premultipliedAlpha && c.enable(9),
                a.shadowMapEnabled && c.enable(10),
                a.doubleSided && c.enable(11),
                a.flipSided && c.enable(12),
                a.useDepthPacking && c.enable(13),
                a.dithering && c.enable(14),
                a.transmission && c.enable(15),
                a.sheen && c.enable(16),
                a.opaque && c.enable(17),
                a.pointsUvs && c.enable(18),
                a.decodeVideoTexture && c.enable(19),
                a.decodeVideoTextureEmissive && c.enable(20),
                a.alphaToCoverage && c.enable(21),
                i.push(c.mask),
                o.push(e.outputColorSpace)),
              o.push(n.customProgramCacheKey),
              o.join()
            );
          },
          ...
          acquireProgram: function (n, t) {
            ...
            return void 0 === r && ((r = new e8(e, t, n, o)), f.push(r)), r;
          },
      ...
      function no() {
        ...
        return {
          ...
          transparent: i,
          init: function () {
            (n = 0), (t.length = 0), (r.length = 0), (i.length = 0);
          },
          ...
          sort: function (e, n) {
            t.length > 1 && t.sort(e || ni),
              r.length > 1 && r.sort(n || na),
              i.length > 1 && i.sort(n || na);
          },
        };
      }
      function nl() {
          ...
          get: function (n) {
            ...
            switch (n.type) {
              case "DirectionalLight":
                t = { direction: new r.Pq0(), color: new r.Q1f() };
                break;
              case "SpotLight":
                t = {
                  position: new r.Pq0(),
      ...
      let nc = 0;
      function nd(e, n) {
        return 2 * !!n.castShadow - 2 * !!e.castShadow + +!!n.map - !!e.map;
      }
      function nu(e) {
        let n = new ns(),
          t = (function () {
        ...
        for (let e = 0; e < 9; e++) i.probe.push(new r.Pq0());
        let a = new r.Pq0(),
          o = new r.kn4(),
          s = new r.kn4();
        return {
          setup: function (r) {
            ...
            for (let e = 0, l = r.length; e < l; e++) {
              ...
              if (l.isAmbientLight)
                ...
                for (let e = 0; e < 9; e++)
                  i.probe[e].addScaledVector(l.sh.coefficients[e], T);
                E++;
                ...
                if (
                  ...
                  (n.shadowIntensity = e.intensity),
                    ...
                    (i.directionalShadowMatrix[c] = l.shadow.matrix),
                    m++;
                }
                (i.directional[c] = e), c++;
                ...
                if (
                  ...
                  (n.shadowIntensity = e.intensity),
                    ...
                    (i.pointShadowMatrix[d] = l.shadow.matrix),
                    h++;
                }
                (i.point[d] = e), d++;
            ...
            f > 0 &&
              (!0 === e.has("OES_texture_float_linear")
                ? ((i.rectAreaLTC1 = l.LTC_FLOAT_1),
                  (i.rectAreaLTC2 = l.LTC_FLOAT_2))
                : ((i.rectAreaLTC1 = l.LTC_HALF_1),
                  (i.rectAreaLTC2 = l.LTC_HALF_2))),
              (i.ambient[0] = a),
              (i.ambient[1] = o),
              (i.ambient[2] = s);
            let S = i.hash;
            (S.directionalLength !== c ||
              ...
              (i.pointShadow.length = h),
              (i.pointShadowMap.length = h),
              (i.spotShadow.length = _),
              (i.spotShadowMap.length = _),
              (i.directionalShadowMatrix.length = m),
              (i.pointShadowMatrix.length = h),
              (i.spotLightMatrix.length = _ + g - v),
      ...
      function nf(e) {
        ...
        return {
          init: function (e) {
            (i.camera = e), (t.length = 0), (r.length = 0);
          },
          state: i,
      ...
      function nm(e, n, t) {
        let i = new r.PPD(),
          ...
          o = new r.I9Y(),
          l = new r.IUQ(),
          s = new r.CSG({ depthPacking: r.N5j }),
          c = new r.aVO(),
          d = {},
          u = t.maxTextureSize,
          f = { [r.hB5]: r.hsX, [r.hsX]: r.hB5, [r.$EB]: r.$EB },
          p = new r.BKk({
            defines: { VSM_SAMPLES: 8 },
            uniforms: {
              shadow_pass: { value: null },
              resolution: { value: new r.I9Y() },
              radius: { value: 4 },
            },
            vertexShader:
              "void main() {\n	gl_Position = vec4( position, 1.0 );\n}",
        ...
        h.setAttribute(
          "position",
          new r.THS(new Float32Array([-1, -1, 0.5, 3, -1, 0.5, -1, 3, 0.5]), 3)
        );
        let _ = new r.eaF(h, p),
          g = this;
        (this.enabled = !1),
        ...
        function E(n, t, i, a) {
          ...
          if (void 0 !== l) o = l;
            ...
            let i = r[n];
            void 0 === i &&
              ((i = o.clone()), (r[n] = i), t.addEventListener("dispose", S)),
              (o = i);
          }
          return (
            (o.visible = t.visible),
        ...
        this.render = function (t, s, c) {
          ...
          S.setBlending(r.XIg),
            ...
            S.setScissorTest(!1);
          let T = v !== r.RyA && this.type === r.RyA,
            M = v === r.RyA && this.type !== r.RyA;
          for (let d = 0, f = t.length; d < f; d++) {
            ...
            if (
              ...
              let e =
                this.type !== r.RyA
                  ? { minFilter: r.hxR, magFilter: r.hxR }
                  : {};
              null !== h.map && h.map.dispose(),
                (h.map = new r.nWS(a.x, a.y, e)),
              ...
              l.set(o.x * a.x, o.y * a.y, o.x * a.z, o.y * a.w),
                ...
                (function t(a, o, l, s, c) {
                  ...
                  if (
                    ...
                    (a.castShadow || (a.receiveShadow && c === r.RyA)) &&
            ...
            !0 !== h.isPointLightShadow &&
              ...
              (function (t, i) {
                ...
                p.defines.VSM_SAMPLES !== t.blurSamples &&
                  ...
                  (p.needsUpdate = !0),
                  (m.needsUpdate = !0)),
                  null === t.mapPass && (t.mapPass = new r.nWS(a.x, a.y)),
                  ...
                  e.clear(),
                  e.renderBufferDirect(i, null, o, p, _, null),
                  ...
                  e.clear(),
                  e.renderBufferDirect(i, null, o, m, _, null);
              })(h, c),
              (h.needsUpdate = !1);
          }
      ...
      function n_(e, n) {
        let t = new (function () {
            ...
            return {
              setMask: function (t) {
                i === t || n || (e.colorMask(t, t, t, t), (i = t));
              },
              setLocked: function (e) {
                n = e;
              },
              setClear: function (n, r, i, o, l) {
                !0 === l && ((n *= o), (r *= o), (i *= o)),
                  t.set(n, r, i, o),
                  !1 === a.equals(t) && (e.clearColor(n, r, i, o), a.copy(t));
              },
              reset: function () {
                (n = !1), (i = null), a.set(-1, 0, 0, 0);
              },
            };
          })(),
          i = new (function () {
            ...
            return {
              setReversed: function (e) {
                if (i !== e) {
                  let t = n.get("EXT_clip_control");
                  e
                    ? t.clipControlEXT(t.LOWER_LEFT_EXT, t.ZERO_TO_ONE_EXT)
                    : t.clipControlEXT(
                        t.LOWER_LEFT_EXT,
                        t.NEGATIVE_ONE_TO_ONE_EXT
                      ),
                    (i = e);
                  let r = l;
                  (l = null), this.setClear(r);
                }
              },
              ...
              setTest: function (n) {
                n ? V(e.DEPTH_TEST) : k(e.DEPTH_TEST);
              },
              setMask: function (n) {
              ...
              setClear: function (n) {
                l !== n && (i && (n = 1 - n), e.clearDepth(n), (l = n));
              },
              reset: function () {
                (t = !1), (a = null), (o = null), (l = null), (i = !1);
              },
            };
          })(),
          a = new (function () {
            ...
            return {
              setTest: function (t) {
                n || (t ? V(e.STENCIL_TEST) : k(e.STENCIL_TEST));
              },
              setMask: function (r) {
                t === r || n || (e.stencilMask(r), (t = r));
              },
              setFunc: function (n, t, o) {
                (r !== n || i !== t || a !== o) &&
                  (e.stencilFunc(n, t, o), (r = n), (i = t), (a = o));
              },
              setOp: function (n, t, r) {
                (o !== n || l !== t || s !== r) &&
                  (e.stencilOp(n, t, r), (o = n), (l = t), (s = r));
              },
              setLocked: function (e) {
                n = e;
              },
        ...
        let I = null,
          ...
          F = new r.IUQ().fromArray(N),
          B = new r.IUQ().fromArray(O);
        function G(n, t, r, i) {
        ...
        let z = {
          [r.gO9]: e.FUNC_ADD,
          [r.FXf]: e.FUNC_SUBTRACT,
          [r.nST]: e.FUNC_REVERSE_SUBTRACT,
        };
        (z[r.znC] = e.MIN), (z[r.$ei] = e.MAX);
        let W = {
          [r.ojh]: e.ZERO,
          [r.qad]: e.ONE,
          [r.f4X]: e.SRC_COLOR,
          [r.ie2]: e.SRC_ALPHA,
          [r.hgQ]: e.SRC_ALPHA_SATURATE,
          [r.wn6]: e.DST_COLOR,
          [r.hdd]: e.DST_ALPHA,
          [r.LiQ]: e.ONE_MINUS_SRC_COLOR,
          [r.OuU]: e.ONE_MINUS_SRC_ALPHA,
          [r.aEY]: e.ONE_MINUS_DST_COLOR,
          [r.Nt7]: e.ONE_MINUS_DST_ALPHA,
          [r.RrE]: e.CONSTANT_COLOR,
          [r.$Yl]: e.ONE_MINUS_CONSTANT_COLOR,
          [r.e0p]: e.CONSTANT_ALPHA,
          [r.ov9]: e.ONE_MINUS_CONSTANT_ALPHA,
        };
        function X(n, t, i, a, o, l, s, c, d, u) {
          if (n === r.XIg) {
            !0 === p && (k(e.BLEND), (p = !1));
            return;
          }
          if ((!1 === p && (V(e.BLEND), (p = !0)), n !== r.bCz)) {
            if (n !== m || u !== x) {
              if (
                ((h !== r.gO9 || v !== r.gO9) &&
                  (e.blendEquation(e.FUNC_ADD), (h = r.gO9), (v = r.gO9)),
                u)
              )
                switch (n) {
                  case r.NTi:
          ...
          (o = o || t),
            ...
            (s = s || a),
            (t !== h || o !== v) &&
              (e.blendEquationSeparate(z[t], z[o]), (h = t), (v = o)),
            (i !== _ || a !== g || l !== E || s !== S) &&
              (e.blendFuncSeparate(W[i], W[a], W[l], W[s]),
              (_ = i),
              (g = a),
              (E = l),
              (S = s)),
        ...
        function Y(n, t, r) {
          n
            ? (V(e.POLYGON_OFFSET_FILL),
              (b !== t || L !== r) && (e.polygonOffset(t, r), (b = t), (L = r)))
            : k(e.POLYGON_OFFSET_FILL);
        }
        return {
          buffers: { color: t, depth: i, stencil: a },
          enable: V,
          disable: k,
          ...
          drawBuffers: function (n, t) {
            let r = u,
              i = !1;
            if (n) {
              void 0 === (r = d.get(t)) && ((r = []), d.set(t, r));
              let a = n.textures;
              if (r.length !== a.length || r[0] !== e.COLOR_ATTACHMENT0) {
                for (let n = 0, t = a.length; n < t; n++)
                  r[n] = e.COLOR_ATTACHMENT0 + n;
          ...
          setMaterial: function (n, o) {
            n.side === r.$EB ? k(e.CULL_FACE) : V(e.CULL_FACE);
            let l = n.side === r.hsX;
            o && (l = !l),
              K(l),
              n.blending === r.NTi && !1 === n.transparent
                ? X(r.XIg)
                : X(
                    n.blending,
                    n.blendEquation,
              ...
              i.setFunc(n.depthFunc),
              i.setTest(n.depthTest),
              i.setMask(n.depthWrite),
          ...
          setLineWidth: function (n) {
            n !== C && (U && e.lineWidth(n), (C = n));
          },
          setPolygonOffset: Y,
          setScissorTest: function (n) {
            n ? V(e.SCISSOR_TEST) : k(e.SCISSOR_TEST);
          },
          activeTexture: function (n) {
            void 0 === n && (n = e.TEXTURE0 + P - 1),
              I !== n && (e.activeTexture(n), (I = n));
          },
          bindTexture: function (n, t, r) {
            void 0 === r && (r = null === I ? e.TEXTURE0 + P - 1 : I);
            let i = y[r];
            void 0 === i &&
              ((i = { type: void 0, texture: void 0 }), (y[r] = i)),
              (i.type !== n || i.texture !== t) &&
          ...
          updateUBOMapping: function (n, t) {
            let r = l.get(t);
            void 0 === r && ((r = new WeakMap()), l.set(t, r));
            let i = r.get(n);
            void 0 === i &&
              ((i = e.getUniformBlockIndex(t, n.name)), r.set(n, i));
          },
          uniformBlockBinding: function (n, t) {
            let r = l.get(t).get(n);
            o.get(t) !== r &&
              (e.uniformBlockBinding(t, r, n.__bindingPointIndex), o.set(t, r));
          },
          ...
          scissor: function (n) {
            !1 === F.equals(n) && (e.scissor(n.x, n.y, n.z, n.w), F.copy(n));
          },
          viewport: function (n) {
            !1 === B.equals(n) && (e.viewport(n.x, n.y, n.z, n.w), B.copy(n));
          },
          reset: function () {
            e.disable(e.BLEND),
      ...
      function ng(e, n, t, i, a, o, l) {
        let s,
          c = n.has("WEBGL_multisampled_render_to_texture")
        ...
        function h(e, n) {
          return m ? new OffscreenCanvas(e, n) : (0, r.qq$)("canvas");
        }
        function _(e, n, t) {
          let r = 1,
            i = V(e);
        ...
        function E(t, i, a, o, l = !1) {
          ...
          if (
            ...
            i === e.RGBA_INTEGER &&
              ...
              a === e.INT && (s = e.RGBA32I)),
            i === e.RGB && a === e.UNSIGNED_INT_5_9_9_9_REV && (s = e.RGB9_E5),
            i === e.RGBA)
          ) {
            let n = l ? r.VxR : r.ppV.getTransfer(o);
            a === e.FLOAT && (s = e.RGBA32F),
              a === e.HALF_FLOAT && (s = e.RGBA16F),
              a === e.UNSIGNED_BYTE &&
                (s = n === r.KLL ? e.SRGB8_ALPHA8 : e.RGBA8),
          ...
          n.removeEventListener("dispose", M),
            (function (e) {
              ...
              let t = e.source,
                r = p.get(t);
              if (r) {
                let i = r[n.__cacheKey];
                i.usedTimes--,
                  0 === i.usedTimes && R(e),
                  0 === Object.keys(r).length && p.delete(t);
              }
              i.remove(e);
            })(n),
        ...
        function x(n) {
          ...
          t.removeEventListener("dispose", x),
            (function (n) {
              ...
              if (
                (n.depthTexture &&
                  (n.depthTexture.dispose(), i.remove(n.depthTexture)),
                n.isWebGLCubeRenderTarget)
              )
                for (let n = 0; n < 6; n++) {
                  if (Array.isArray(t.__webglFramebuffer[n]))
                    for (let r = 0; r < t.__webglFramebuffer[n].length; r++)
                      e.deleteFramebuffer(t.__webglFramebuffer[n][r]);
        ...
        function C(n, r) {
          ...
          if (
            ...
            if (null === e)
              ...
              if (!1 !== e.complete) return void w(a, n, r);
              console.warn(
        ...
        let b = {
            [r.GJx]: e.REPEAT,
            [r.ghU]: e.CLAMP_TO_EDGE,
            [r.kTW]: e.MIRRORED_REPEAT,
          },
          L = {
            [r.hxR]: e.NEAREST,
            [r.pHI]: e.NEAREST_MIPMAP_NEAREST,
            [r.Cfg]: e.NEAREST_MIPMAP_LINEAR,
            [r.k6q]: e.LINEAR,
            [r.kRr]: e.LINEAR_MIPMAP_NEAREST,
            [r.$_I]: e.LINEAR_MIPMAP_LINEAR,
          },
          P = {
            [r.amv]: e.NEVER,
            [r.FFZ]: e.ALWAYS,
        ...
        function U(t, o) {
          if (
            ...
            e.texParameteri(t, e.TEXTURE_WRAP_S, b[o.wrapS]),
            e.texParameteri(t, e.TEXTURE_WRAP_T, b[o.wrapT]),
            (t === e.TEXTURE_3D || t === e.TEXTURE_2D_ARRAY) &&
              e.texParameteri(t, e.TEXTURE_WRAP_R, b[o.wrapR]),
            ...
            o.magFilter !== r.hxR &&
            (o.minFilter === r.Cfg || o.minFilter === r.$_I) &&
            (o.type !== r.RQf || !1 !== n.has("OES_texture_float_linear")) &&
            (o.anisotropy > 1 || i.get(o).__currentAnisotropy)
          ) {
            let r = n.get("EXT_texture_filter_anisotropic");
            e.texParameterf(
              t,
        ...
        function D(n, t) {
          ...
          if (o !== n.__cacheKey) {
            void 0 === a[o] &&
              ...
              (r = !0)),
              a[o].usedTimes++;
            let i = a[n.__cacheKey];
            void 0 !== i &&
              (a[n.__cacheKey].usedTimes--, 0 === i.usedTimes && R(t)),
              (n.__cacheKey = o),
        ...
        function w(n, l, s) {
          ...
          if (u.version !== f.__version || !0 === d) {
            ...
            let i = r.ppV.getPrimaries(r.ppV.workingColorSpace),
              p =
                l.colorSpace === r.jf0
                  ? null
                  : r.ppV.getPrimaries(l.colorSpace),
              m =
                l.colorSpace === r.jf0 || i === p
                  ? e.NONE
            ...
            U(c, l);
            let A = l.mipmaps,
              C = !0 !== l.isVideoTexture,
              b = void 0 === f.__version || !0 === d,
              L = u.dataReady,
              P = T(l, h);
            if (l.isDepthTexture)
              (R = S(l.format === r.dcC, l.type)),
                b &&
                  (C
              ...
              if (A.length > 0) {
                ...
                C
                  ? (b && t.texStorage2D(e.TEXTURE_2D, P, R, h.width, h.height),
                    L &&
                      t.texSubImage2D(
                        e.TEXTURE_2D,
                        0,
                      ...
                      if (C) {
                        if (L)
                          if (l.layerUpdates.size > 0) {
                            ...
                            for (let r of l.layerUpdates) {
                              let o = n.data.subarray(
                                (r * a) / n.data.BYTES_PER_ELEMENT,
              ...
              if (C) {
                if (
                  ...
                  if (l.layerUpdates.size > 0) {
                    let n = (0, r.Nex)(h.width, h.height, l.format, l.type);
                    for (let r of l.layerUpdates) {
                      let i = h.data.subarray(
                        (r * n) / h.data.BYTES_PER_ELEMENT,
              ...
              if (b)
                if (C) t.texStorage2D(e.TEXTURE_2D, P, R, h.width, h.height);
                else {
                  let n = h.width,
                    r = h.height;
                  for (let i = 0; i < P; i++)
                    t.texImage2D(e.TEXTURE_2D, i, R, n, r, 0, M, x, null),
                      (n >>= 1),
                      (r >>= 1);
                }
            } else if (A.length > 0) {
              ...
              for (let r = 0, i = A.length; r < i; r++)
                (n = A[r]),
                  C
                    ? L && t.texSubImage2D(e.TEXTURE_2D, r, 0, 0, M, x, n)
                    : t.texImage2D(e.TEXTURE_2D, r, R, M, x, n);
              l.generateMipmaps = !1;
            } else if (C) {
              if (b) {
                let n = V(h);
        ...
        function I(n, r, a, l, s, d) {
          ...
          if (((h.__renderTarget = r), !m.__hasExternalTextures)) {
            let n = Math.max(1, r.width >> d),
              i = Math.max(1, r.height >> d);
            s === e.TEXTURE_3D || s === e.TEXTURE_2D_ARRAY
              ? t.texImage3D(s, d, p, n, i, r.depth, 0, u, f, null)
          ...
          if (n.depthTexture && !a.__autoAllocateDepthBuffer) {
            ...
            !(function (n, a) {
              ...
              let l = o.__webglTexture,
                s = B(a);
              if (a.depthTexture.format === r.zdS)
                G(a)
                  ? c.framebufferTexture2DMultisampleEXT(
                      e.FRAMEBUFFER,
                      e.DEPTH_ATTACHMENT,
              ...
              else if (a.depthTexture.format === r.dcC)
                G(a)
                  ? c.framebufferTexture2DMultisampleEXT(
                      e.FRAMEBUFFER,
                      e.DEPTH_STENCIL_ATTACHMENT,
            ...
            for (let r = 0; r < 6; r++)
              if (
                (t.bindFramebuffer(e.FRAMEBUFFER, a.__webglFramebuffer[r]),
                void 0 === a.__webglDepthbuffer[r])
              )
                (a.__webglDepthbuffer[r] = e.createRenderbuffer()),
                  y(a.__webglDepthbuffer[r], n, !1);
              else {
                let t = n.stencilBuffer
                    ? e.DEPTH_STENCIL_ATTACHMENT
                    : e.DEPTH_ATTACHMENT,
                  i = a.__webglDepthbuffer[r];
            ...
            (a.__webglDepthbuffer = e.createRenderbuffer()),
              y(a.__webglDepthbuffer, n, !1);
          else {
            let t = n.stencilBuffer
                ? e.DEPTH_STENCIL_ATTACHMENT
                : e.DEPTH_ATTACHMENT,
              r = a.__webglDepthbuffer;
            e.bindRenderbuffer(e.RENDERBUFFER, r),
              e.framebufferRenderbuffer(e.FRAMEBUFFER, t, e.RENDERBUFFER, r);
          }
          t.bindFramebuffer(e.FRAMEBUFFER, null);
        }
        let O = [],
        ...
        (this.allocateTextureUnit = function () {
          ...
          (this.setTexture2D = C),
          (this.setTexture2DArray = function (n, r) {
            let a = i.get(n);
          ...
          (this.rebindTextures = function (n, t, r) {
            let a = i.get(n);
            void 0 !== t &&
              I(
              ...
              if (n.samples > 0 && !1 === G(n)) {
                ...
                e.bindRenderbuffer(e.RENDERBUFFER, null),
                  n.depthBuffer &&
                    ...
                    y(a.__webglDepthRenderbuffer, n, !0)),
                  t.bindFramebuffer(e.FRAMEBUFFER, null);
              }
            }
            if (d) {
              ...
              g(r) && v(e.TEXTURE_CUBE_MAP), t.unbindTexture();
            } else if (u) {
              ...
              if (
                ((n.isWebGL3DRenderTarget || n.isWebGLArrayRenderTarget) &&
                  (i = n.isWebGL3DRenderTarget
                    ? e.TEXTURE_3D
                    : e.TEXTURE_2D_ARRAY),
                t.bindTexture(i, s.__webglTexture),
                U(i, r),
                r.mipmaps && r.mipmaps.length > 0)
              )
                for (let t = 0; t < r.mipmaps.length; t++)
                  I(a.__webglFramebuffer[t], n, r, e.COLOR_ATTACHMENT0, i, t);
              else I(a.__webglFramebuffer, n, r, e.COLOR_ATTACHMENT0, i, 0);
              g(r) && v(i), t.unbindTexture();
            }
            n.depthBuffer && N(n);
          }),
          (this.updateRenderTargetMipmap = function (n) {
            ...
            for (let a = 0, o = r.length; a < o; a++) {
              let o = r[a];
              if (g(o)) {
                let r = n.isWebGLCubeRenderTarget
                    ? e.TEXTURE_CUBE_MAP
                ...
                t.bindTexture(r, a), v(r), t.unbindTexture();
              }
            }
          }),
              ...
              if (!1 === G(n)) {
                ...
                for (let t = 0; t < r.length; t++) {
                  if (
                    ...
                    let n = i.get(r[t]).__webglTexture;
                    e.framebufferTexture2D(
                      e.DRAW_FRAMEBUFFER,
                      e.COLOR_ATTACHMENT0,
                      e.TEXTURE_2D,
                ...
                if (
                  ...
                  for (let n = 0; n < r.length; n++) {
                    ...
                    let a = i.get(r[n]).__webglTexture;
                    t.bindFramebuffer(e.FRAMEBUFFER, c.__webglFramebuffer),
                      e.framebufferTexture2D(
                        e.DRAW_FRAMEBUFFER,
                        e.COLOR_ATTACHMENT0 + n,
      ...
      function nv(e, n) {
        return {
          convert: function (t, i = r.jf0) {
            let a,
              o = r.ppV.getTransfer(i);
            if (t === r.OUM) return e.UNSIGNED_BYTE;
            if (t === r.Wew) return e.UNSIGNED_SHORT_4_4_4_4;
            if (t === r.gJ2) return e.UNSIGNED_SHORT_5_5_5_1;
            if (t === r.Dmk) return e.UNSIGNED_INT_5_9_9_9_REV;
            if (t === r.tJf) return e.BYTE;
            if (t === r.fBL) return e.SHORT;
            if (t === r.cHt) return e.UNSIGNED_SHORT;
            if (t === r.Yuy) return e.INT;
            if (t === r.bkx) return e.UNSIGNED_INT;
            if (t === r.RQf) return e.FLOAT;
            if (t === r.ix0) return e.HALF_FLOAT;
            if (t === r.wrO) return e.ALPHA;
            if (t === r.HIg) return e.RGB;
            if (t === r.GWd) return e.RGBA;
            if (t === r.Kzv) return e.LUMINANCE;
            if (t === r.CMB) return e.LUMINANCE_ALPHA;
            if (t === r.zdS) return e.DEPTH_COMPONENT;
            if (t === r.dcC) return e.DEPTH_STENCIL;
            if (t === r.VT0) return e.RED;
            if (t === r.ZQM) return e.RED_INTEGER;
            if (t === r.paN) return e.RG;
            if (t === r.TkQ) return e.RG_INTEGER;
            if (t === r.c90) return e.RGBA_INTEGER;
            if (t === r.IE4 || t === r.Nz6 || t === r.jR7 || t === r.BXX)
              if (o === r.KLL) {
                if (null === (a = n.get("WEBGL_compressed_texture_s3tc_srgb")))
                  return null;
                if (t === r.IE4) return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;
                if (t === r.Nz6) return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;
                if (t === r.jR7) return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;
                if (t === r.BXX) return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT;
              } else {
                if (null === (a = n.get("WEBGL_compressed_texture_s3tc")))
                  return null;
                if (t === r.IE4) return a.COMPRESSED_RGB_S3TC_DXT1_EXT;
                if (t === r.Nz6) return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;
                if (t === r.jR7) return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;
                if (t === r.BXX) return a.COMPRESSED_RGBA_S3TC_DXT5_EXT;
              }
            if (t === r.k6Q || t === r.kTp || t === r.HXV || t === r.pBf) {
              if (null === (a = n.get("WEBGL_compressed_texture_pvrtc")))
                return null;
              if (t === r.k6Q) return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
              if (t === r.kTp) return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;
              if (t === r.HXV) return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
              if (t === r.pBf) return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
            }
            if (t === r.CVz || t === r.Riy || t === r.KDk) {
            ...
            if (t === r.Fn || t === r.H23 || t === r.W9U) {
              ...
              if (t === r.H23) return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
              if (t === r.W9U) return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
            }
            if (t === r.Kef || t === r.XG_ || t === r.HO_ || t === r.CWW) {
              if (null === (a = n.get("EXT_texture_compression_rgtc")))
                return null;
              if (t === r.Fn) return a.COMPRESSED_RED_RGTC1_EXT;
              if (t === r.XG_) return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;
              if (t === r.HO_) return a.COMPRESSED_RED_GREEN_RGTC2_EXT;
              if (t === r.CWW) return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT;
            }
            return t === r.V3x
              ? e.UNSIGNED_INT_24_8
              : void 0 !== e[t]
	...
	if ( coord.x >= 1.0 ) {
      ...
      class nT {
        ...
        init(e, n, t) {
          if (null === this.texture) {
            let i = new r.gPd();
            (e.properties.get(i).__webglTexture = n.texture),
        ...
        getMesh(e) {
          if (null !== this.texture && null === this.mesh) {
            ...
            this.mesh = new r.eaF(new r.bdM(20, 20), t);
          }
          return this.mesh;
        }
        reset() {
      ...
      class nM extends r.Qev {
        constructor(e, n) {
          ...
          let t = this,
            ...
            x = null,
            R = new r.ubm();
          R.viewport = new r.IUQ();
          let A = new r.ubm();
          A.viewport = new r.IUQ();
          let C = [R, A],
            b = new r.nZQ(),
            L = null,
            P = null;
          ...
          function D() {
            a.removeEventListener("select", U),
              ...
              a.removeEventListener("inputsourceschange", w);
            ...
            (this.setSession = async function (i) {
              if (null !== (a = i)) {
                if (
                  ...
                  a.addEventListener("inputsourceschange", w),
                  ...
                  g.depth &&
                    ...
                    (t = g.stencil ? r.dcC : r.zdS),
                    (i = g.stencil ? r.V3x : r.bkx));
                  let s = {
                    colorFormat: n.RGBA8,
                    depthFormat: l,
                    scaleFactor: o,
                  ...
                  (p = (f = new XRWebGLBinding(a, n)).createProjectionLayer(s)),
                    ...
                    (E = new r.nWS(p.textureWidth, p.textureHeight, {
                      format: r.GWd,
                      type: r.OUM,
                      depthTexture: new r.VCu(
                        p.textureWidth,
                        p.textureHeight,
                        i,
                        void 0,
                  ...
                  (m = new XRWebGLLayer(a, n, t)),
                    ...
                    (E = new r.nWS(m.framebufferWidth, m.framebufferHeight, {
                      format: r.GWd,
                      type: r.OUM,
                      colorSpace: e.outputColorSpace,
                      stencilBuffer: g.stencil,
          ...
          (this.updateCamera = function (e) {
            ...
            null !== _.texture &&
              ...
              _.depthFar > 0 && (l = _.depthFar)),
              (b.near = A.near = R.near = o),
              (b.far = A.far = R.far = l),
              (L !== b.near || P !== b.far) &&
                (a.updateRenderState({ depthNear: b.near, depthFar: b.far }),
                (L = b.near),
                (P = b.far)),
              (R.layers.mask = 2 | e.layers.mask),
              (A.layers.mask = 4 | e.layers.mask),
              (b.layers.mask = R.layers.mask | A.layers.mask);
            let s = e.parent,
              c = b.cameras;
            N(b, s);
            for (let e = 0; e < c.length; e++) N(c[e], s);
            2 === c.length
              ? (function (e, n, t) {
                  I.setFromMatrixPosition(n.matrixWorld),
                    y.setFromMatrixPosition(t.matrixWorld);
                  let r = I.distanceTo(y),
              ...
              : b.projectionMatrix.copy(R.projectionMatrix),
              (n = e),
              (t = b),
              null === (i = s)
                ? n.matrix.copy(t.matrixWorld)
                : (n.matrix.copy(i.matrixWorld),
                  n.matrix.invert(),
              ...
              n.isPerspectiveCamera &&
                ((n.fov =
                  2 * r.a55 * Math.atan(1 / n.projectionMatrix.elements[5])),
                (n.zoom = 1));
          }),
          ...
          let O = null,
            F = new i();
          F.setAnimationLoop(function (n, i) {
            if (((u = i.getViewerPose(d || l)), (h = i), null !== u)) {
              let n = u.views;
              null !== m &&
                (e.setRenderTargetFramebuffer(E, m.framebuffer),
                e.setRenderTarget(E));
              let t = !1;
              n.length !== b.cameras.length &&
                ((b.cameras.length = 0), (t = !0));
              for (let i = 0; i < n.length; i++) {
                let a = n[i],
                  o = null;
                  ...
                  (o = n.viewport),
                    0 === i &&
                      (e.setRenderTargetTextures(
                        E,
                        n.colorTexture,
                        n.depthStencilTexture
                      ),
                      e.setRenderTarget(E));
                }
                let l = C[i];
                void 0 === l &&
                  ((l = new r.ubm()).layers.enable(i),
                  (l.viewport = new r.IUQ()),
                  (C[i] = l)),
                  ...
                  0 === i &&
                    (b.matrix.copy(l.matrix),
                    b.matrix.decompose(b.position, b.quaternion, b.scale)),
                  !0 === t && b.cameras.push(l);
              }
              let i = a.enabledFeatures;
              if (
                i &&
            ...
            for (let e = 0; e < S.length; e++) {
              let n = T[e],
                t = S[e];
              null !== n && void 0 !== t && t.update(n, i, d || l);
            }
            O && O(n, i),
              i.detectedPlanes &&
                t.dispatchEvent({ type: "planesdetected", data: i }),
              (h = null);
          }),
      ...
      function nA(e, n) {
        ...
        function i(e, i) {
          (e.opacity.value = i.opacity),
            ...
            i.map && ((e.map.value = i.map), t(i.map, e.mapTransform)),
            i.alphaMap &&
              ((e.alphaMap.value = i.alphaMap),
              t(i.alphaMap, e.alphaMapTransform)),
            i.bumpMap &&
              ((e.bumpMap.value = i.bumpMap),
              t(i.bumpMap, e.bumpMapTransform),
              (e.bumpScale.value = i.bumpScale),
              i.side === r.hsX && (e.bumpScale.value *= -1)),
            i.normalMap &&
              ((e.normalMap.value = i.normalMap),
              t(i.normalMap, e.normalMapTransform),
              e.normalScale.value.copy(i.normalScale),
              i.side === r.hsX && e.normalScale.value.negate()),
            i.displacementMap &&
              ((e.displacementMap.value = i.displacementMap),
              t(i.displacementMap, e.displacementMapTransform),
            ...
            i.emissiveMap &&
              ...
              t(i.emissiveMap, e.emissiveMapTransform)),
            i.specularMap &&
              ((e.specularMap.value = i.specularMap),
              t(i.specularMap, e.specularMapTransform)),
          ...
          o &&
            ...
            o.isCubeTexture &&
              ...
              ((nx.y *= -1), (nx.z *= -1)),
            e.envMapRotation.value.setFromMatrix4(nR.makeRotationFromEuler(nx)),
            (e.flipEnvMap.value =
            ...
            i.lightMap &&
              ...
              t(i.lightMap, e.lightMapTransform)),
            i.aoMap &&
              ((e.aoMap.value = i.aoMap),
              (e.aoMapIntensity.value = i.aoMapIntensity),
              t(i.aoMap, e.aoMapTransform));
        }
        return {
          refreshFogUniforms: function (n, t) {
            t.color.getRGB(n.fogColor.value, (0, r._Ut)(e)),
              t.isFog
          ...
          refreshMaterialUniforms: function (e, a, o, l, s) {
            var c, d, u, f, p, m, h, _, g, v, E, S, T, M, x, R, A, C, b, L, P;
            a.isMeshBasicMaterial || a.isMeshLambertMaterial
              ? i(e, a)
              : a.isMeshToonMaterial
              ? (i(e, a),
                (c = e),
                (d = a).gradientMap && (c.gradientMap.value = d.gradientMap))
              : a.isMeshPhongMaterial
              ? (i(e, a),
                (u = e),
                (f = a),
                u.specular.value.copy(f.specular),
                (u.shininess.value = Math.max(f.shininess, 1e-4)))
              ...
              ? (i(e, a),
                ...
                a.isMeshPhysicalMaterial &&
                  ...
                  _.sheen > 0 &&
                    (h.sheenColor.value
                      .copy(_.sheenColor)
                      .multiplyScalar(_.sheen),
                    (h.sheenRoughness.value = _.sheenRoughness),
                    _.sheenColorMap &&
                      ((h.sheenColorMap.value = _.sheenColorMap),
                      t(_.sheenColorMap, h.sheenColorMapTransform)),
                    _.sheenRoughnessMap &&
                      ((h.sheenRoughnessMap.value = _.sheenRoughnessMap),
                      t(_.sheenRoughnessMap, h.sheenRoughnessMapTransform))),
                  _.clearcoat > 0 &&
                    ((h.clearcoat.value = _.clearcoat),
                    (h.clearcoatRoughness.value = _.clearcoatRoughness),
                    _.clearcoatMap &&
                      ((h.clearcoatMap.value = _.clearcoatMap),
                      t(_.clearcoatMap, h.clearcoatMapTransform)),
                    ...
                    _.clearcoatNormalMap &&
                      ((h.clearcoatNormalMap.value = _.clearcoatNormalMap),
                      t(_.clearcoatNormalMap, h.clearcoatNormalMapTransform),
                      h.clearcoatNormalScale.value.copy(_.clearcoatNormalScale),
                      _.side === r.hsX &&
                        h.clearcoatNormalScale.value.negate())),
                  _.dispersion > 0 && (h.dispersion.value = _.dispersion),
                  _.iridescence > 0 &&
                    ((h.iridescence.value = _.iridescence),
                    (h.iridescenceIOR.value = _.iridescenceIOR),
                    (h.iridescenceThicknessMinimum.value =
                      _.iridescenceThicknessRange[0]),
                    (h.iridescenceThicknessMaximum.value =
                      _.iridescenceThicknessRange[1]),
                    _.iridescenceMap &&
                      ((h.iridescenceMap.value = _.iridescenceMap),
                      t(_.iridescenceMap, h.iridescenceMapTransform)),
                  ...
                  _.transmission > 0 &&
                    ((h.transmission.value = _.transmission),
                    (h.transmissionSamplerMap.value = g.texture),
                    h.transmissionSamplerSize.value.set(g.width, g.height),
                    _.transmissionMap &&
                      ((h.transmissionMap.value = _.transmissionMap),
                      t(_.transmissionMap, h.transmissionMapTransform)),
                    (h.thickness.value = _.thickness),
                    _.thicknessMap &&
                      ((h.thicknessMap.value = _.thicknessMap),
                      t(_.thicknessMap, h.thicknessMapTransform)),
                    (h.attenuationDistance.value = _.attenuationDistance),
                    h.attenuationColor.value.copy(_.attenuationColor)),
                  _.anisotropy > 0 &&
                    ...
                    _.anisotropyMap &&
                      ((h.anisotropyMap.value = _.anisotropyMap),
                      t(_.anisotropyMap, h.anisotropyMapTransform))),
                  (h.specularIntensity.value = _.specularIntensity),
                  h.specularColor.value.copy(_.specularColor),
                  _.specularColorMap &&
                    ((h.specularColorMap.value = _.specularColorMap),
                    t(_.specularColorMap, h.specularColorMapTransform)),
                  _.specularIntensityMap &&
                    ((h.specularIntensityMap.value = _.specularIntensityMap),
                    t(
                      _.specularIntensityMap,
              ...
              ? (i(e, a),
                (v = e),
                (E = a).matcap && (v.matcap.value = E.matcap))
              ...
              ? ((S = e),
                (T = a),
                S.diffuse.value.copy(T.color),
                (S.opacity.value = T.opacity),
                T.map && ((S.map.value = T.map), t(T.map, S.mapTransform)),
                a.isLineDashedMaterial &&
                  ((M = e),
                  (x = a),
                  (M.dashSize.value = x.dashSize),
                  (M.totalSize.value = x.dashSize + x.gapSize),
                  (M.scale.value = x.scale)))
              : a.isPointsMaterial
              ? ((R = e),
                (A = a),
                (C = o),
                (b = l),
                R.diffuse.value.copy(A.color),
                (R.opacity.value = A.opacity),
                (R.size.value = A.size * C),
                (R.scale.value = 0.5 * b),
                A.map && ((R.map.value = A.map), t(A.map, R.uvTransform)),
                A.alphaMap &&
                  ((R.alphaMap.value = A.alphaMap),
                  t(A.alphaMap, R.alphaMapTransform)),
                A.alphaTest > 0 && (R.alphaTest.value = A.alphaTest))
              : a.isSpriteMaterial
              ? ((L = e),
                (P = a),
                L.diffuse.value.copy(P.color),
                (L.opacity.value = P.opacity),
                (L.rotation.value = P.rotation),
                P.map && ((L.map.value = P.map), t(P.map, L.mapTransform)),
                P.alphaMap &&
                  ((L.alphaMap.value = P.alphaMap),
                  t(P.alphaMap, L.alphaMapTransform)),
                P.alphaTest > 0 && (L.alphaTest.value = P.alphaTest))
              : a.isShadowMaterial
      ...
      function nC(e, n, t, r) {
        ...
        function c(n) {
          ...
          let r = o.indexOf(t.__bindingPointIndex);
          o.splice(r, 1),
            e.deleteBuffer(i[t.id]),
            delete i[t.id],
            delete a[t.id];
        }
        return {
          ...
          update: function (t, d) {
            ...
            void 0 === u &&
              ((function (e) {
                ...
                for (let e = 0, r = n.length; e < r; e++) {
                  let r = Array.isArray(n[e]) ? n[e] : [n[e]];
                ...
                let r = t % 16;
                r > 0 && (t += 16 - r), (e.__size = t), (e.__cache = {});
              })(t),
              (u = (function (n) {
                let t = (function () {
                  for (let e = 0; e < l; e++)
            ...
            a[t.id] !== p &&
              ((function (n) {
                ...
                for (let n = 0, t = r.length; n < t; n++) {
                  let t = Array.isArray(r[n]) ? r[n] : [r[n]];
                  for (let r = 0, i = t.length; r < i; r++) {
                    let i = t[r];
                    if (
                      !0 ===
                      ...
                      for (let a = 0; a < t.length; a++) {
                        ...
                        "number" == typeof o || "boolean" == typeof o
                          ? ((i.__data[0] = o),
                            e.bufferSubData(e.UNIFORM_BUFFER, n + r, i.__data))
                          : o.isMatrix3
                      ...
                      e.bufferSubData(e.UNIFORM_BUFFER, n, i.__data);
                    }
                  }
                }
                e.bindBuffer(e.UNIFORM_BUFFER, null);
          ...
          dispose: function () {
            for (let n in i) e.deleteBuffer(i[n]);
            (o = []), (i = {}), (a = {});
          },
        };
      }
      class nb {
        constructor(e = {}) {
          ...
          (this.domElement = k),
            ...
            (this.toneMapping = r.y_p),
            (this.toneMappingExposure = 1),
            (this.transmissionResolutionScale = 1);
          let ea = this,
            eo = !1;
          this._outputColorSpace = r.er$;
          let el = 0,
            es = 0,
            ec = null,
            ed = -1,
            ...
            eS = null,
            eT = null,
            eM = new r.IUQ(0, 0, eg, ev),
            ex = new r.IUQ(0, 0, eg, ev),
            eR = !1,
            eA = new r.PPD(),
            eC = !1,
            eb = !1,
          ...
          try {
            if (
              ("setAttribute" in k &&
                k.setAttribute("data-engine", `three.js r${r.sPf}`),
              k.addEventListener("webglcontextlost", eG, !1),
              k.addEventListener("webglcontextrestored", eH, !1),
          ...
          function eF() {
            (t = new O(eN)).init(),
              ...
              (P = new H(eN, o, d)),
              (C = new _(c)),
              (M = new nt(ea, u, v, t, o, I, C)),
              (x = new nA(ea, c)),
              (R = new nl()),
              (A = new np(t)),
              (L = new f(ea, u, v, l, T, n, Y)),
              (b = new nm(ea, T, o)),
              (y = new nC(eN, s, o, l)),
              (U = new m(eN, t, s)),
              (D = new B(eN, t, s)),
          ...
          function ek(e) {
            var n;
            let t = e.target;
            t.removeEventListener("dispose", ek),
              (function (e) {
          ...
          function ez(e, n, t) {
            !0 === e.transparent && e.side === r.$EB && !1 === e.forceSinglePass
              ? ((e.side = r.hsX),
                (e.needsUpdate = !0),
                e0(e, n, t),
                (e.side = r.hB5),
          ...
          (this.xr = eB),
            ...
            (this.setViewport = function (e, n, t, r) {
              e.isVector4 ? eM.set(e.x, e.y, e.z, e.w) : eM.set(e, n, t, r),
                l.viewport(ef.copy(eM).multiplyScalar(eE).round());
            }),
            (this.getScissor = function (e) {
              return e.copy(ex);
            }),
            (this.setScissor = function (e, n, t, r) {
              e.isVector4 ? ex.set(e.x, e.y, e.z, e.w) : ex.set(e, n, t, r),
            ...
            (this.setClearColor = function () {
              L.setClearColor(...arguments);
            }),
            (this.getClearAlpha = function () {
              return L.getClearAlpha();
            }),
            (this.setClearAlpha = function () {
              L.setClearAlpha(...arguments);
            }),
            (this.clear = function (e = !0, n = !0, t = !0) {
              ...
              if (e) {
                ...
                } else i |= eN.COLOR_BUFFER_BIT;
              }
              n && (i |= eN.DEPTH_BUFFER_BIT),
                t &&
                  ((i |= eN.STENCIL_BUFFER_BIT),
            ...
            (this.dispose = function () {
              k.removeEventListener("webglcontextlost", eG, !1),
                k.removeEventListener("webglcontextrestored", eH, !1),
                ...
                M.dispose(),
                eB.dispose(),
                eB.removeEventListener("sessionstart", eK),
                eB.removeEventListener("sessionend", eq),
                eY.stop();
            }),
            (this.renderBufferDirect = function (e, n, i, a, s, f) {
              let p;
              null === n && (n = ew);
              let m = s.isMesh && 0 > s.matrixWorld.determinant(),
                h = (function (e, n, t, i, a) {
                  var s, f;
                  !0 !== n.isScene && (n = ew), d.resetTextureUnits();
                  let p = n.fog,
                    m = i.isMeshStandardMaterial ? n.environment : null,
                    h =
                      null === ec
                        ? ea.outputColorSpace
                        ...
                        : r.Zr2,
                    _ = (i.isMeshStandardMaterial ? v : u).get(i.envMap || m),
                    g =
                      !0 === i.vertexColors &&
                      !!t.attributes.color &&
                    ...
                    S = !!t.morphAttributes.position,
                    T = !!t.morphAttributes.normal,
                    M = !!t.morphAttributes.color,
                    R = r.y_p;
                  i.toneMapped &&
                  ...
                  i.version === L.__version
                    ? (L.needsLights &&
                        L.lightsStateVersion !== U.state.version) ||
                      L.outputColorSpace !== h ||
                      (a.isBatchedMesh && !1 === L.batching)
                      ? (D = !0)
                      : a.isBatchedMesh || !0 !== L.batching
                      ? (a.isBatchedMesh &&
                          !0 === L.batchingColor &&
                          null === a.colorTexture) ||
                        (a.isBatchedMesh &&
                          !1 === L.batchingColor &&
                          null !== a.colorTexture) ||
                        (a.isInstancedMesh && !1 === L.instancing)
                        ? (D = !0)
                        : a.isInstancedMesh || !0 !== L.instancing
                        ? a.isSkinnedMesh && !1 === L.skinning
                          ? (D = !0)
                          : a.isSkinnedMesh || !0 !== L.skinning
                          ? (a.isInstancedMesh &&
                              !0 === L.instancingColor &&
                            ...
                            (void 0 !== L.numClippingPlanes &&
                              (L.numClippingPlanes !== C.numPlanes ||
                                L.numIntersection !== C.numIntersection)) ||
                            L.vertexAlphas !== g ||
                            L.vertexTangents !== E ||
                            L.morphTargets !== S ||
                            L.morphNormals !== T ||
                            ...
                            L.toneMapping !== R
                            ? (D = !0)
                            : L.morphTargetsCount !== b && (D = !0)
                          : (D = !0)
                        : (D = !0)
                      : (D = !0)
                    : ((D = !0), (L.__version = i.version));
                  let w = L.currentProgram;
                  !0 === D && (w = e0(i, n, a));
                  let I = !1,
                    N = !1,
                    O = !1,
                    ...
                    B = L.uniforms;
                  if (
                    (l.useProgram(w.program) && ((I = !0), (N = !0), (O = !0)),
                    i.id !== ed && ((ed = i.id), (N = !0)),
                    I || eu !== e)
                  ) {
                  ...
                  if (a.isSkinnedMesh) {
                    F.setOptional(eN, a, "bindMatrix"),
                      F.setOptional(eN, a, "bindMatrixInverse");
                    let e = a.skeleton;
                    e &&
                      (null === e.boneTexture && e.computeBoneTexture(),
                      F.setValue(eN, "boneTexture", e.boneTexture, d));
                  }
                  a.isBatchedMesh &&
                    (F.setOptional(eN, a, "batchingTexture"),
                    F.setValue(eN, "batchingTexture", a._matricesTexture, d),
                    F.setOptional(eN, a, "batchingIdTexture"),
                    F.setValue(eN, "batchingIdTexture", a._indirectTexture, d),
                    F.setOptional(eN, a, "batchingColorTexture"),
                  ...
                  let G = t.morphAttributes;
                  if (
                    ((void 0 !== G.position ||
                      void 0 !== G.normal ||
                      void 0 !== G.color) &&
                      P.update(a, t, w),
                    (N || L.receiveShadow !== a.receiveShadow) &&
                      ((L.receiveShadow = a.receiveShadow),
                      F.setValue(eN, "receiveShadow", a.receiveShadow)),
                    ...
                    i.isMeshStandardMaterial &&
                      null === i.envMap &&
                      null !== n.environment &&
                      (B.envMapIntensity.value = n.environmentIntensity),
                    N &&
                      (F.setValue(
                        eN,
                        "toneMappingExposure",
                      ...
                      p && !0 === i.fog && x.refreshFogUniforms(B, p),
                      ...
                      eX.upload(eN, e3(L), B, d)),
                    i.isShaderMaterial &&
                      !0 === i.uniformsNeedUpdate &&
                      (eX.upload(eN, e3(L), B, d), (i.uniformsNeedUpdate = !1)),
                    i.isSpriteMaterial && F.setValue(eN, "center", a.center),
                    F.setValue(eN, "modelViewMatrix", a.modelViewMatrix),
                    F.setValue(eN, "normalMatrix", a.normalMatrix),
                    F.setValue(eN, "modelMatrix", a.matrixWorld),
                    i.isShaderMaterial || i.isRawShaderMaterial)
                  ) {
                    let e = i.uniformsGroups;
                    for (let n = 0, t = e.length; n < t; n++) {
                      let t = e[n];
                      y.update(t, w), y.bind(t, w);
                    }
                  }
                  return w;
                })(e, n, i, a, s);
              ...
              let _ = i.index,
                g = 1;
              if (!0 === a.wireframe) {
                if (void 0 === (_ = S.getWireframeAttribute(i))) return;
                g = 2;
              }
              let T = i.drawRange,
              ...
              let L = U;
              if (
                (null !== _ && ((p = E.get(_)), (L = D).setIndex(p)), s.isMesh)
              )
                !0 === a.wireframe
                  ? (l.setLineWidth(a.wireframeLinewidth * ey()),
                    L.setMode(eN.LINES))
              ...
              if (s.isBatchedMesh)
                if (null !== s._multiDrawInstances)
                  ...
                  let e = s._multiDrawStarts,
                    ...
                    t = s._multiDrawCount,
                    r = _ ? E.get(_).bytesPerElement : 1,
                    i = c.get(a).currentProgram.getUniforms();
                  for (let a = 0; a < t; a++)
                    i.setValue(eN, "_gl_DrawID", a), L.render(e[a] / r, n[a]);
                }
              else if (s.isInstancedMesh) L.renderInstances(R, b, s.count);
              else if (i.isInstancedBufferGeometry) {
                let e =
                    void 0 !== i._maxInstanceCount
                      ? i._maxInstanceCount
                      : 1 / 0,
                  n = Math.min(i.instanceCount, e);
                L.renderInstances(R, b, n);
              } else L.render(R, b);
            }),
              ...
              return (
                e.traverse(function (e) {
                  ...
                  if (n)
                    ...
                    else ez(n, t, e), r.add(n);
                }),
                (et = ei.pop()),
                r
              );
            }),
            (this.compileAsync = function (e, n, r = null) {
              let i = this.compile(e, n, r);
              return new Promise((n) => {
                function r() {
                  if (
                    (i.forEach(function (e) {
                      c.get(e).currentProgram.isReady() && i.delete(e);
                    }),
                    0 === i.size)
                  )
                    return void n(e);
            ...
            if (e.layers.test(n.layers)) {
              if (e.isGroup) t = e.renderOrder;
                ...
                if (!e.frustumCulled || eA.intersectsSprite(e)) {
                  r && eD.setFromMatrixPosition(e.matrixWorld).applyMatrix4(eP);
                  let n = T.update(e),
                    i = e.material;
                  i.visible && en.push(e, n, i, t, eD.z, null);
                }
              } else if (
                  ...
                  (r &&
                    (void 0 !== e.boundingSphere
                      ? (null === e.boundingSphere && e.computeBoundingSphere(),
                        eD.copy(e.boundingSphere.center))
                      : (null === n.boundingSphere && n.computeBoundingSphere(),
                        eD.copy(n.boundingSphere.center)),
                    eD.applyMatrix4(e.matrixWorld).applyMatrix4(eP)),
                  Array.isArray(i))
                ) {
                  let r = n.groups;
                  for (let a = 0, o = r.length; a < o; a++) {
                    let o = r[a],
                      l = i[o.materialIndex];
                    l && l.visible && en.push(e, n, l, t, eD.z, o);
                  }
                } else i.visible && en.push(e, n, i, t, eD.z, null);
              }
            }
            let i = e.children;
            for (let e = 0, a = i.length; e < a; e++) ej(i[e], n, t, r);
          }
          function eQ(e, n, t, r) {
            let i = e.opaque,
              a = e.transmissive,
            ...
            et.setupLightsView(t),
              !0 === eC && C.setGlobalState(ea.clippingPlanes, t),
              r && l.viewport(ef.copy(r)),
              i.length > 0 && e$(i, n, t),
              a.length > 0 && e$(a, n, t),
              o.length > 0 && e$(o, n, t),
          ...
          function eZ(e, n, i, a) {
            ...
            void 0 === et.state.transmissionRenderTarget[a.id] &&
              (et.state.transmissionRenderTarget[a.id] = new r.nWS(1, 1, {
                generateMipmaps: !0,
                type:
                ...
                colorSpace: r.ppV.workingColorSpace,
              }));
            let o = et.state.transmissionRenderTarget[a.id],
              l = a.viewport || ef;
            o.setSize(
              l.z * ea.transmissionResolutionScale,
              l.w * ea.transmissionResolutionScale
            );
            ...
            ea.toneMapping = r.y_p;
            let u = a.viewport;
            if (
              (void 0 !== a.viewport && (a.viewport = void 0),
              et.setupLightsView(a),
              !0 === eC && C.setGlobalState(ea.clippingPlanes, a),
              e$(e, i, a),
              ...
              for (let t = 0, o = n.length; t < o; t++) {
                let o = n[t],
                  ...
                  c = o.material,
                  d = o.group;
                if (c.side === r.$EB && l.layers.test(a.layers)) {
                  let n = c.side;
                  (c.side = r.hsX),
                    (c.needsUpdate = !0),
                    eJ(l, i, a, s, c, d),
          ...
          function e$(e, n, t) {
            let r = !0 === n.isScene ? n.overrideMaterial : null;
            for (let i = 0, a = e.length; i < a; i++) {
              ...
              !0 === c.allowOverride && null !== r && (c = r),
                o.layers.test(t.layers) && eJ(o, n, t, l, c, s);
            }
          }
          function eJ(e, n, t, i, a, o) {
            e.onBeforeRender(ea, n, t, i, a, o),
              e.modelViewMatrix.multiplyMatrices(
                t.matrixWorldInverse,
                e.matrixWorld
              ),
              e.normalMatrix.getNormalMatrix(e.modelViewMatrix),
              a.onBeforeRender(ea, n, t, i, e, o),
              !0 === a.transparent &&
              a.side === r.$EB &&
              !1 === a.forceSinglePass
                ? ((a.side = r.hsX),
                  (a.needsUpdate = !0),
                  ea.renderBufferDirect(t, n, i, a, e, o),
                  (a.side = r.hB5),
                  (a.needsUpdate = !0),
                  ea.renderBufferDirect(t, n, i, a, e, o),
                  (a.side = r.$EB))
                : ea.renderBufferDirect(t, n, i, a, e, o),
              e.onAfterRender(ea, n, t, i, a, o);
          }
          function e0(e, n, t) {
            var r;
            !0 !== n.isScene && (n = ew);
            let i = c.get(e),
              a = et.state.lights,
              o = et.state.shadowsArray,
              l = a.state.version,
              s = M.getParameters(e, a.state, o, n, t),
              d = M.getProgramCacheKey(s),
              f = i.programs;
            (i.environment = e.isMeshStandardMaterial ? n.environment : null),
              ...
              void 0 === f &&
                ...
                (i.programs = f = new Map()));
            let p = f.get(d);
            if (void 0 !== p) {
              if (i.currentProgram === p && i.lightsStateVersion === l)
                return e1(e, s), p;
            } else
              (s.uniforms = M.getUniforms(e)),
                e.onBeforeCompile(s, ea),
                (p = M.acquireProgram(s, d)),
                f.set(d, p),
            ...
            return (
              ((e.isShaderMaterial || e.isRawShaderMaterial) &&
                !0 !== e.clipping) ||
                (m.clippingPlanes = C.uniform),
              e1(e, s),
              (i.needsLights =
                (r = e).isMeshLambertMaterial ||
                r.isMeshToonMaterial ||
                r.isMeshPhongMaterial ||
                r.isMeshStandardMaterial ||
                r.isShadowMaterial ||
                (r.isShaderMaterial && !0 === r.lights)),
              (i.lightsStateVersion = l),
              i.needsLights &&
          ...
          function e3(e) {
            if (null === e.uniformsList) {
              ...
              e.uniformsList = eX.seqWithValue(n.seq, e.uniforms);
            }
          ...
          eY.setAnimationLoop(function (e) {
            ...
            "undefined" != typeof self && eY.setContext(self),
            (this.setAnimationLoop = function (e) {
              (eW = e),
                eB.setAnimationLoop(e),
                null === e ? eY.stop() : eY.start();
            }),
            eB.addEventListener("sessionstart", eK),
            eB.addEventListener("sessionend", eq),
            (this.render = function (e, n) {
              ...
              if (
                ...
                (et = A.get(e, ei.length)).init(n),
                ei.push(et),
                eP.multiplyMatrices(n.projectionMatrix, n.matrixWorldInverse),
                eA.setFromProjectionMatrix(eP),
                (eb = this.localClippingEnabled),
                (eC = C.init(this.clippingPlanes, eb)),
                (en = R.get(e, er.length)).init(),
                er.push(en),
              ...
              if ((et.setupLights(), n.isArrayCamera)) {
                let t = n.cameras;
                if (i.length > 0)
                  for (let n = 0, a = t.length; n < a; n++) eZ(r, i, e, t[n]);
                eI && L.render(e);
                for (let n = 0, r = t.length; n < r; n++) {
                  let r = t[n];
                  eQ(en, e, r, r.viewport);
                }
              } else
                i.length > 0 && eZ(r, i, e, n), eI && L.render(e), eQ(en, e, n);
              null !== ec &&
                0 === es &&
                ...
                ei.length > 0
                  ? ((et = ei[ei.length - 1]),
                    !0 === eC &&
                      C.setGlobalState(ea.clippingPlanes, et.state.camera))
                  : (et = null),
                er.pop(),
                (en = er.length > 0 ? er[er.length - 1] : null);
            }),
            ...
            (this.setRenderTargetTextures = function (e, n, t) {
              let r = c.get(e);
              (r.__autoAllocateDepthBuffer = !1 === e.resolveDepthBuffer),
                ...
                (c.get(e.depthTexture).__webglTexture =
                  r.__autoAllocateDepthBuffer ? void 0 : t),
          ...
          (this.setRenderTarget = function (e, n = 0, t = 0) {
            ...
            if (e) {
              ...
              if (void 0 !== s.__useDefaultFramebuffer)
                l.bindFramebuffer(eN.FRAMEBUFFER, null), (r = !1);
              else if (void 0 === s.__webglFramebuffer) d.setupRenderTarget(e);
              ...
              e.isWebGLCubeRenderTarget
                ? ((i = Array.isArray(f[n]) ? f[n][t] : f[n]), (a = !0))
                : (i =
            ...
            if (
              (0 !== t && (i = e2),
              l.bindFramebuffer(eN.FRAMEBUFFER, i) && r && l.drawBuffers(e, i),
              l.viewport(ef),
              l.scissor(ep),
              l.setScissorTest(em),
              a)
            ) {
              let r = c.get(e.texture);
            ...
            (this.readRenderTargetPixels = function (e, n, t, r, i, a, s) {
              ...
              if (
                ...
                try {
                  ...
                  n >= 0 &&
                    ...
                    t >= 0 &&
                    t <= e.height - i &&
                    eN.readPixels(n, t, r, i, w.convert(s), w.convert(c), a);
                } finally {
            ...
            (this.readRenderTargetPixelsAsync = async function (
              ...
              if ((e.isWebGLCubeRenderTarget && void 0 !== d && (u = u[d]), u))
                if (n >= 0 && n <= e.width - i && t >= 0 && t <= e.height - a) {
                  ...
                  eN.bindBuffer(eN.PIXEL_PACK_BUFFER, m),
                    ...
                    eN.readPixels(n, t, i, a, w.convert(f), w.convert(p), 0);
                  let h = null !== ec ? c.get(ec).__webglFramebuffer : null;
                  l.bindFramebuffer(eN.FRAMEBUFFER, h);
                  let _ = eN.fenceSync(eN.SYNC_GPU_COMMANDS_COMPLETE, 0);
                  return (
                    eN.flush(),
                    await (0, r.jej)(eN, _, 4),
                    eN.bindBuffer(eN.PIXEL_PACK_BUFFER, m),
            ...
            (this.copyFramebufferToTexture = function (e, n = null, t = 0) {
              let r = Math.pow(2, -t),
                ...
                s = null !== n ? n.y : 0;
              d.setTexture2D(e, 0),
                eN.copyTexSubImage2D(eN.TEXTURE_2D, t, 0, 0, o, s, i, a),
                l.unbindTexture();
            });
          let e4 = eN.createFramebuffer(),
            e5 = eN.createFramebuffer();
          (this.copyTextureToTexture = function (
            ...
            let x = eN.getParameter(eN.UNPACK_ROW_LENGTH),
              ...
              C = eN.getParameter(eN.UNPACK_SKIP_ROWS),
              b = eN.getParameter(eN.UNPACK_SKIP_IMAGES);
            ...
            if (e.isDepthTexture) {
              let t = c.get(e),
                r = c.get(n),
                i = c.get(t.__renderTarget),
                d = c.get(r.__renderTarget);
              l.bindFramebuffer(eN.READ_FRAMEBUFFER, i.__webglFramebuffer),
              ...
              let t = c.get(e),
                r = c.get(n);
              l.bindFramebuffer(eN.READ_FRAMEBUFFER, e4),
                l.bindFramebuffer(eN.DRAW_FRAMEBUFFER, e5);
              for (let e = 0; e < f; e++)
                L
                  ? eN.framebufferTextureLayer(
                      eN.READ_FRAMEBUFFER,
            ...
            eN.pixelStorei(eN.UNPACK_ROW_LENGTH, x),
              ...
              eN.pixelStorei(eN.UNPACK_SKIP_ROWS, C),
              eN.pixelStorei(eN.UNPACK_SKIP_IMAGES, b),
            ...
            (this.copyTextureToTexture3D = function (
              ...
              return (
                ...
                this.copyTextureToTexture(e, n, t, i, a)
              );
            }),
            ...
            (this.resetState = function () {
              (el = 0), (es = 0), (ec = null), l.reset(), I.reset();
            }),
        ...
        set outputColorSpace(e) {
          ...
          (n.drawingBufferColorSpace = r.ppV._getDrawingBufferColorSpace(e)),
            (n.unpackColorSpace = r.ppV._getUnpackColorSpace());
        }
      }
    },
  },
